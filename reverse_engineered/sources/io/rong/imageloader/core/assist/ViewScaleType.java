...
public enum ViewScaleType {
    ...
    /* renamed from: io.rong.imageloader.core.assist.ViewScaleType$1 */
    static /* synthetic */ class C49691 {
    ...
    public static ViewScaleType fromImageView(ImageView imageView) {
        switch (C49691.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
