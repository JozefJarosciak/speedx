...
class StrictLineReader implements Closeable {
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.in) {
            ...
            ByteArrayOutputStream c49621 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
            ...
            loop1:
            while (true) {
                c49621.write(this.buf, this.pos, this.end - this.pos);
                this.end = -1;
                fillBuf();
                i = this.pos;
                while (i != this.end) {
            ...
            if (i != this.pos) {
                c49621.write(this.buf, this.pos, i - this.pos);
            }
            this.pos = i + 1;
            str = c49621.toString();
        }
