...
class RongIMClient$76 implements Runnable {
    ...
    /* renamed from: io.rong.imlib.RongIMClient$76$1 */
    class C53111 extends Stub {
        C53111() {
        }

        public void onComplete() throws RemoteException {
            if (RongIMClient$76.this.val$callback != null) {
                RongIMClient$76.this.val$callback.onCallback();
            }
        }
    ...
    RongIMClient$76(RongIMClient rongIMClient, RongIMClient$OperationCallback rongIMClient$OperationCallback, String str, int i) {
    ...
    public void run() {
        if (RongIMClient.access$400(this.this$0) != null) {
            try {
                RongIMClient.access$400(this.this$0).joinExistChatRoom(this.val$chatroomId, this.val$defMessageCount, new C53111());
