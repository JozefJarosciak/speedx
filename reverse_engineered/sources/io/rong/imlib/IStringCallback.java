...
public interface IStringCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IStringCallback {
        ...
        public static IStringCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface == null || !(queryLocalInterface instanceof IStringCallback)) {
                return new Proxy(iBinder);
            }
            return (IStringCallback) queryLocalInterface;
        }
