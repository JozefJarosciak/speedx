...
public interface IUploadCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUploadCallback {
        ...
        public static IUploadCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface == null || !(queryLocalInterface instanceof IUploadCallback)) {
                return new Proxy(iBinder);
            }
            return (IUploadCallback) queryLocalInterface;
        }
