...
public class BasicHeaderValueParser implements HeaderValueParser {
    ...
    public NameValuePair parseNameValuePair(CharArrayBuffer charArrayBuffer, ParserCursor parserCursor, char[] cArr) {
        ...
        while (i2 < upperBound) {
            ...
            if (charAt2 == CoreConstants.DOUBLE_QUOTE_CHAR && obj3 == null) {
            ...
            if (obj3 != null) {
                obj4 = null;
            } else if (obj5 == null || charAt2 != CoreConstants.ESCAPE_CHAR) {
                obj4 = null;
            } else {
                pos2 = 1;
            }
        ...
        if (pos2 - i3 >= 2 && charArrayBuffer.charAt(i3) == CoreConstants.DOUBLE_QUOTE_CHAR && charArrayBuffer.charAt(pos2 - 1) == CoreConstants.DOUBLE_QUOTE_CHAR) {
            i3++;
            pos2--;
        }
