...
public class VersionInfo {
    ...
    public String toString() {
        ...
        stringBuilder.append("VersionInfo(").append(this.infoPackage).append(CoreConstants.COLON_CHAR).append(this.infoModule);
        if (!UNAVAILABLE.equals(this.infoRelease)) {
            stringBuilder.append(CoreConstants.COLON_CHAR).append(this.infoRelease);
        }
        if (!UNAVAILABLE.equals(this.infoTimestamp)) {
            stringBuilder.append(CoreConstants.COLON_CHAR).append(this.infoTimestamp);
        }
    ...
    public static VersionInfo loadVersionInfo(String str, ClassLoader classLoader) {
        ...
        try {
            resourceAsStream = classLoader.getResourceAsStream(str.replace(CoreConstants.DOT, '/') + "/" + VERSION_PROPERTY_FILE);
