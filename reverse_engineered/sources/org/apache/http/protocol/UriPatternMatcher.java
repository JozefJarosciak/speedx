...
public class UriPatternMatcher<T> {
    ...
    public synchronized T lookup(String str) {
        ...
        if (t == null) {
            ...
            for (String str3 : this.map.keySet()) {
                String str32;
                T t2;
                if (matchUriRequestPattern(str32, str) && (str2 == null || str2.length() < str32.length() || (str2.length() == str32.length() && str32.endsWith(Marker.ANY_MARKER)))) {
    ...
    protected boolean matchUriRequestPattern(String str, String str2) {
        ...
        if ((str.endsWith(Marker.ANY_MARKER) && str2.startsWith(str.substring(0, str.length() - 1))) || (str.startsWith(Marker.ANY_MARKER) && str2.endsWith(str.substring(1, str.length())))) {
            z = true;
        }
        return z;
    }
