...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01531();
    ...
    static class C01531 implements Creator<PlaybackStateCompat> {
        C01531() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01541();
        ...
        static class C01541 implements Creator<CustomAction> {
            C01541() {
            }
