...
public class TransportMediator extends TransportController {
    ...
    class C01371 implements TransportMediatorCallback {
        C01371() {
        }
    ...
    class C01382 implements Callback {
        C01382() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer transportPerformer) {
        ...
        this.mTransportKeyCallback = new C01371();
        this.mKeyEventCallback = new C01382();
