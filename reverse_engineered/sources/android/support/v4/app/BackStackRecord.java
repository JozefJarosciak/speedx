...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, Runnable {
    ...
    private boolean configureTransitions(int i, TransitionState transitionState, boolean z, SparseArray<Fragment> sparseArray, SparseArray<Fragment> sparseArray2) {
        ...
        if (sharedElementTransition != null) {
            ...
            if (map.isEmpty()) {
                ...
                if (mergeTransitions != null) {
                    FragmentTransitionCompat21.addTransitionTargets(enterTransition, obj, captureExitingViews, view, c00781, transitionState.nonExistentView, transitionState.enteringEpicenterView, transitionState.nameOverrides, arrayList2, arrayList, map, arrayMap, arrayList3);
        ...
        c00781 = /* anonymous class already generated */;
        arrayList2 = new ArrayList();
        arrayMap = new ArrayMap();
        z2 = true;
        if (fragment != null) {
