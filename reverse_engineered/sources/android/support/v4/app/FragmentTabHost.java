...
public class FragmentTabHost extends TabHost implements OnTabChangeListener {
    ...
    static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C00931();
        String curTab;
        ...
        public String toString() {
            return "FragmentTabHost.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " curTab=" + this.curTab + C0880h.f2222d;
        }
    }
