...
public class FragmentActivity extends BaseFragmentActivityJB implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    final Handler mHandler = new C00841();
    ...
    private static String viewToString(View view) {
        ...
        stringBuilder.append(view.isFocusable() ? 'F' : CoreConstants.DOT);
        stringBuilder.append(view.isEnabled() ? 'E' : CoreConstants.DOT);
        stringBuilder.append(view.willNotDraw() ? CoreConstants.DOT : 'D');
        stringBuilder.append(view.isHorizontalScrollBarEnabled() ? 'H' : CoreConstants.DOT);
        stringBuilder.append(view.isVerticalScrollBarEnabled() ? 'V' : CoreConstants.DOT);
        stringBuilder.append(view.isClickable() ? 'C' : CoreConstants.DOT);
        stringBuilder.append(view.isLongClickable() ? 'L' : CoreConstants.DOT);
        stringBuilder.append(' ');
        if (!view.isFocused()) {
            c = CoreConstants.DOT;
        }
        stringBuilder.append(c);
        stringBuilder.append(view.isSelected() ? 'S' : CoreConstants.DOT);
        if (view.isPressed()) {
            c2 = 'P';
        }
        ...
        stringBuilder.append(CoreConstants.DASH_CHAR);
