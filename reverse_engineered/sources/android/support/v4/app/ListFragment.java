...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00992();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00981();
    ...
    class C00992 implements OnItemClickListener {
        C00992() {
        }
