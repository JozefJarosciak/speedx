...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01801();
    ...
    private static final Interpolator sInterpolator = new C01812();
    ...
    private final Runnable mEndScrollRunnable = new C01823();
    ...
    static class C01801 implements Comparator<ItemInfo> {
        C01801() {
        }
    ...
    static class C01812 implements Interpolator {
        C01812() {
        }
    ...
    class C01834 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return "FragmentPager.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " position=" + this.position + C0880h.f2222d;
        }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C01834());
    }
                ...
                if (!layoutParams.isDecor) {
                    ...
                    if (infoForChild != null) {
                        ...
                        if (layoutParams.needsMeasure) {
                            ...
                            childAt2.measure(MeasureSpec.makeMeasureSpec((int) (layoutParams.widthFactor * ((float) max)), Ints.MAX_POWER_OF_TWO), MeasureSpec.makeMeasureSpec((i6 - paddingTop) - paddingBottom, Ints.MAX_POWER_OF_TWO));
                        }
