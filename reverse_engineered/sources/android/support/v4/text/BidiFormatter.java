    ...
    private static class DirectionalityEstimator {
        ...
        private byte skipTagForward() {
            ...
            while (this.charIndex < this.length) {
                ...
                if (this.lastChar == CoreConstants.DOUBLE_QUOTE_CHAR || this.lastChar == CoreConstants.SINGLE_QUOTE_CHAR) {
        ...
        private byte skipTagBackward() {
            ...
            while (this.charIndex > 0) {
                ...
                if (this.lastChar == '>') {
                    break;
                } else if (this.lastChar == CoreConstants.DOUBLE_QUOTE_CHAR || this.lastChar == CoreConstants.SINGLE_QUOTE_CHAR) {
                    char c = this.lastChar;
                    while (this.charIndex > 0) {
                        String str2 = this.text;
