...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private final Callback mCallback = new C02033();
    boolean mFinishing;
    ...
    class C02033 implements Callback {
        C02033() {
        }
    ...
    private void setupAnimators() {
        ...
        Animation c02011 = new Animation() {
        ...
        c02011.setRepeatCount(-1);
        c02011.setRepeatMode(1);
        c02011.setInterpolator(LINEAR_INTERPOLATOR);
        c02011.setAnimationListener(new AnimationListener() {
