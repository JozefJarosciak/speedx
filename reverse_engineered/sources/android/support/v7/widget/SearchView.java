...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C03124 implements OnFocusChangeListener {
        C03124() {
        }
    ...
    class C03135 implements OnLayoutChangeListener {
        C03135() {
        }
    ...
    class C03146 implements OnGlobalLayoutListener {
        C03146() {
        }
    ...
    class C03168 implements OnKeyListener {
        C03168() {
        }
    ...
    class C03179 implements OnEditorActionListener {
        C03179() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03181());
        boolean isIconified;

        /* renamed from: android.support.v7.widget.SearchView$SavedState$1 */
        static class C03181 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03181() {
            }
        ...
        public String toString() {
            return "SearchView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " isIconified=" + this.isIconified + C0880h.f2222d;
        }
    }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0246R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0246R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mShowImeRunnable = new C03091();
        this.mUpdateDrawableStateRunnable = new C03102();
        this.mReleaseCursorRunnable = new C03113();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C03157();
        this.mTextKeyListener = new C03168();
        this.mOnEditorActionListener = new C03179();
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0246R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C0246R.styleable.SearchView_layout, C0246R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0246R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0246R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0246R.id.search_plate);
        this.mSubmitArea = findViewById(C0246R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0246R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0246R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0246R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0246R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0246R.id.search_mag_icon);
        this.mSearchPlate.setBackgroundDrawable(obtainStyledAttributes.getDrawable(C0246R.styleable.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(obtainStyledAttributes.getDrawable(C0246R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0246R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0246R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0246R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0246R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(obtainStyledAttributes.getDrawable(C0246R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = obtainStyledAttributes.getDrawable(C0246R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = obtainStyledAttributes.getResourceId(C0246R.styleable.SearchView_suggestionRowLayout, C0246R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = obtainStyledAttributes.getResourceId(C0246R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C03124());
        setIconifiedByDefault(obtainStyledAttributes.getBoolean(C0246R.styleable.SearchView_iconifiedByDefault, true));
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0246R.styleable.SearchView_android_maxWidth, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = obtainStyledAttributes.getText(C0246R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = obtainStyledAttributes.getText(C0246R.styleable.SearchView_queryHint);
        dimensionPixelSize = obtainStyledAttributes.getInt(C0246R.styleable.SearchView_android_imeOptions, -1);
        if (dimensionPixelSize != -1) {
            setImeOptions(dimensionPixelSize);
        }
        dimensionPixelSize = obtainStyledAttributes.getInt(C0246R.styleable.SearchView_android_inputType, -1);
        if (dimensionPixelSize != -1) {
            setInputType(dimensionPixelSize);
        }
        setFocusable(obtainStyledAttributes.getBoolean(C0246R.styleable.SearchView_android_focusable, true));
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C03135());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C03146());
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        super.onMeasure(MeasureSpec.makeMeasureSpec(size, Ints.MAX_POWER_OF_TWO), MeasureSpec.makeMeasureSpec(mode, Ints.MAX_POWER_OF_TWO));
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0246R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0246R.dimen.abc_search_view_preferred_height);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                dimensionPixelSize = resources.getDimensionPixelSize(C0246R.dimen.abc_dropdownitem_text_padding_left) + resources.getDimensionPixelSize(C0246R.dimen.abc_dropdownitem_icon_width);
            } else {
