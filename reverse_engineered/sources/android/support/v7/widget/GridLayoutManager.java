...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    void layoutChunk(Recycler recycler, State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        Object obj = modeInOther != Ints.MAX_POWER_OF_TWO ? 1 : null;
        ...
        for (i3 = 0; i3 < i2; i3++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i5) {
                ...
                if (this.mOrientation == 1) {
                    spanSize = LayoutManager.getChildMeasureSpec(spaceForSpanRange, Ints.MAX_POWER_OF_TWO, spanSize, layoutParams.width, false);
                    i4 = MeasureSpec.makeMeasureSpec(i5 - i6, Ints.MAX_POWER_OF_TWO);
                } else {
                    spanSize = MeasureSpec.makeMeasureSpec(i5 - spanSize, Ints.MAX_POWER_OF_TWO);
                    i4 = LayoutManager.getChildMeasureSpec(spaceForSpanRange, Ints.MAX_POWER_OF_TWO, i6, layoutParams.height, false);
                }
