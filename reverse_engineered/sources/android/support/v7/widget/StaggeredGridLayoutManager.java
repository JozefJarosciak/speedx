...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    private final Runnable mCheckForGapsRunnable = new C03211();
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new C03221();
            int mGapDir;
            int[] mGapPerSpan;
            ...
            static class C03221 implements Creator<FullSpanItem> {
                C03221() {
                }
    ...
    int findFirstVisibleItemPositionInt() {
        ...
        if (this.mShouldReverseLayout) {
            findFirstVisibleItemClosestToEnd = findFirstVisibleItemClosestToEnd(true, true);
        } else {
            findFirstVisibleItemClosestToEnd = findFirstVisibleItemClosestToStart(true, true);
        }
