    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (mode == Integer.MIN_VALUE) {
            ...
            if (!(typedValue == null || typedValue.type == 0)) {
                ...
                if (dimension > 0) {
                    i = MeasureSpec.makeMeasureSpec(Math.min(dimension - (this.mDecorPadding.left + this.mDecorPadding.right), MeasureSpec.getSize(i)), Ints.MAX_POWER_OF_TWO);
                    obj = 1;
                    if (mode2 == Integer.MIN_VALUE) {
                        ...
                        if (!(typedValue == null || typedValue.type == 0)) {
                            ...
                            if (dimension > 0) {
                                i2 = MeasureSpec.makeMeasureSpec(Math.min(dimension - (this.mDecorPadding.top + this.mDecorPadding.bottom), MeasureSpec.getSize(i2)), Ints.MAX_POWER_OF_TWO);
                            }
                        }
                    }
                    super.onMeasure(i, i2);
                    mode2 = getMeasuredWidth();
                    dimension = MeasureSpec.makeMeasureSpec(mode2, Ints.MAX_POWER_OF_TWO);
                    if (obj == null && mode == Integer.MIN_VALUE) {
                        ...
                        if (!(typedValue2 == null || typedValue2.type == 0)) {
                            ...
                            if (mode2 < dimension2) {
                                dimension2 = MeasureSpec.makeMeasureSpec(dimension2, Ints.MAX_POWER_OF_TWO);
                                obj2 = 1;
                                if (obj2 == null) {
