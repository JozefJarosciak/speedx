...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    private class TabView extends LinearLayoutCompat implements OnLongClickListener {
        ...
        public TabView(Context context, Tab tab, boolean z) {
            super(context, null, C0246R.attr.actionBarTabStyle);
            this.mTab = tab;
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0246R.attr.actionBarTabStyle, 0);
        ...
        public void update() {
            ...
            if (z) {
                if (this.mTextView == null) {
                    appCompatImageView = new AppCompatTextView(getContext(), null, C0246R.attr.actionBarTabTextStyle);
    ...
    public void onMeasure(int i, int i2) {
        ...
        boolean z = mode == Ints.MAX_POWER_OF_TWO;
        setFillViewport(z);
        int childCount = this.mTabLayout.getChildCount();
        if (childCount <= 1 || !(mode == Ints.MAX_POWER_OF_TWO || mode == Integer.MIN_VALUE)) {
            this.mMaxTabWidth = -1;
        } else {
            if (childCount > 2) {
        ...
        mode = MeasureSpec.makeMeasureSpec(this.mContentHeight, Ints.MAX_POWER_OF_TWO);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, C0246R.attr.actionBarTabBarStyle);
    ...
    private Spinner createSpinner() {
        Spinner appCompatSpinner = new AppCompatSpinner(getContext(), null, C0246R.attr.actionDropDownStyle);
