...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    static final int[] ATTRS = new int[]{C0246R.attr.actionBarSize, 16842841};
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new C02661();
        this.mRemoveActionBarHideOffset = new C02672();
        this.mAddActionBarHideOffset = new C02683();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0246R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0246R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0246R.id.action_bar));
        }
    }
