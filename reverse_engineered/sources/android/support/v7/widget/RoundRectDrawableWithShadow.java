...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, int i, float f, float f2, float f3) {
        this.mShadowStartColor = resources.getColor(C0247R.color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0247R.color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0247R.dimen.cardview_compat_inset_shadow);
