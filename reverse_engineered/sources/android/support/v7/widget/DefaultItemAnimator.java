    ...
    public void runPendingAnimations() {
        ...
        if (i4 != 0 || i != 0 || i3 != 0 || i2 != 0) {
            ...
            if (i != 0) {
                ...
                if (i4 != 0) {
                    ViewCompat.postOnAnimationDelayed(((MoveInfo) arrayList.get(0)).holder.itemView, c02831, getRemoveDuration());
                } else {
                    c02831.run();
                }
            }
            if (i2 != 0) {
                ...
                if (i4 != 0) {
                    ViewCompat.postOnAnimationDelayed(((ChangeInfo) arrayList.get(0)).oldHolder.itemView, c02831, getRemoveDuration());
                } else {
                    c02831.run();
                }
            }
            if (i3 != 0) {
                ...
                ViewCompat.postOnAnimationDelayed(((ViewHolder) arrayList2.get(0)).itemView, c02853, removeDuration + Math.max(moveDuration, changeDuration));
            }
        }
    }
