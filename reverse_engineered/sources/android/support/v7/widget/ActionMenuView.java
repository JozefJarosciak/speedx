...
public class ActionMenuView extends LinearLayoutCompat implements ItemInvoker, MenuView {
        ...
        if (obj2 != null) {
            for (paddingLeft = 0; paddingLeft < childCount; paddingLeft++) {
                ...
                if (layoutParams.expanded) {
                    childAt.measure(MeasureSpec.makeMeasureSpec(layoutParams.extraPixels + (layoutParams.cellsUsed * i6), Ints.MAX_POWER_OF_TWO), childMeasureSpec);
                }
            }
        }
        if (mode == 1073741824) {
    ...
    static int measureChildForCells(View view, int i, int i2, int i3, int i4) {
        ...
        view.measure(MeasureSpec.makeMeasureSpec(i5 * i, Ints.MAX_POWER_OF_TWO), makeMeasureSpec);
        return i5;
    }
