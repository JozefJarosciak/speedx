...
import android.support.v7.recyclerview.C0248R;
...
public class RecyclerView extends ViewGroup implements NestedScrollingChild, ScrollingView {
    ...
    static final Interpolator sQuinticInterpolator = new C03023();
    ...
    public static abstract class LayoutManager {
        ...
        public static int getChildMeasureSpec(int i, int i2, int i3, int i4, boolean z) {
            ...
            if (i4 >= 0) {
                ...
                if (z) {
                    ...
                    if (i2 == Integer.MIN_VALUE || i2 == Ints.MAX_POWER_OF_TWO) {
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0248R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0248R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0248R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0248R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0248R.styleable.RecyclerView_stackFromEnd, false);
    ...
    static class C03023 implements Interpolator {
        C03023() {
        }
    ...
    class C03034 implements ProcessCallback {
        C03034() {
        }
    ...
    class C03045 implements Callback {
        C03045() {
        }
    ...
    class C03056 implements Callback {
        C03056() {
        }
    ...
    public final class Recycler {
        ...
        void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                ...
                boolean z2 = RecyclerView.this.mAdapter != null && access$700 && RecyclerView.this.mAdapter.onFailedToRecycleView(viewHolder);
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new C03001();
        ...
        this.mItemAnimatorRunner = new C03012();
        this.mViewInfoProcessCallback = new C03034();
        ...
        if (attributeSet != null) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0248R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes.getString(C0248R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes.getInt(C0248R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
    ...
    private String getFullClassName(Context context, String str) {
        if (str.charAt(0) == CoreConstants.DOT) {
            return context.getPackageName() + str;
        }
        return !str.contains(".") ? RecyclerView.class.getPackage().getName() + CoreConstants.DOT + str : str;
    }

    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C03045());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C03056());
    }
