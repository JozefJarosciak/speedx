...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02431();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02442();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02453();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$1 */
    class C02431 extends ViewPropertyAnimatorListenerAdapter {
        C02431() {
        }
    ...
    class C02442 extends ViewPropertyAnimatorListenerAdapter {
        C02442() {
        }
    ...
    class C02453 implements ViewPropertyAnimatorUpdateListener {
        C02453() {
        }
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0246R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0246R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0246R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0246R.id.action_bar_container);
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0246R.styleable.ActionBar, C0246R.attr.actionBarStyle, 0);
        if (obtainStyledAttributes.getBoolean(C0246R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0246R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0246R.attr.actionBarWidgetTheme, typedValue, true);
