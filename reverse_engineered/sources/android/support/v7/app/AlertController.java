...
class AlertController {
    ...
    private final OnClickListener mButtonHandler = new C02211();
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                Object c02272 = new CursorAdapter(this.mContext, this.mCursor, false) {
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0246R.styleable.AlertDialog, C0246R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0246R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0246R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0246R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0246R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0246R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0246R.styleable.AlertDialog_listItemLayout, 0);
    ...
    private void setupView() {
        boolean z;
        boolean z2;
        View findViewById = this.mWindow.findViewById(C0246R.id.parentPanel);
        View findViewById2 = findViewById.findViewById(C0246R.id.topPanel);
        View findViewById3 = findViewById.findViewById(C0246R.id.contentPanel);
        View findViewById4 = findViewById.findViewById(C0246R.id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById.findViewById(C0246R.id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById5 = viewGroup.findViewById(C0246R.id.topPanel);
        View findViewById6 = viewGroup.findViewById(C0246R.id.contentPanel);
        View findViewById7 = viewGroup.findViewById(C0246R.id.buttonPanel);
        ...
        if (!(z2 || resolvePanel2 == null)) {
            findViewById3 = resolvePanel2.findViewById(C0246R.id.textSpacerNoButtons);
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        View view2 = null;
        View findViewById = this.mWindow.findViewById(C0246R.id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C0246R.id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0246R.id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0246R.id.title_template).setVisibility(8);
            return;
        }
        this.mIconView = (ImageView) this.mWindow.findViewById(16908294);
        if ((!TextUtils.isEmpty(this.mTitle) ? 1 : 0) != 0) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0246R.id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0246R.id.scrollView);
