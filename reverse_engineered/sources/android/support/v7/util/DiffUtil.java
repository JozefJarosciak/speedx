...
public class DiffUtil {
    private static final Comparator<Snake> SNAKE_COMPARATOR = new C02511();

    /* renamed from: android.support.v7.util.DiffUtil$1 */
    static class C02511 implements Comparator<Snake> {
        C02511() {
        }
        ...
        while (i10 <= i9) {
            ...
            while (i11 <= i10) {
                ...
                if (obj == null || i11 < (i8 - i10) + 1 || i11 > (i8 + i10) - 1 || iArr[i5 + i11] < iArr2[i5 + i11]) {
                    ...
                    snake.f9x = iArr2[i5 + i11];
                    snake.f10y = snake.f9x - i11;
