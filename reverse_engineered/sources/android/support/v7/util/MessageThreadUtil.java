...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    public MainThreadCallback<T> getMainThreadProxy(final MainThreadCallback<T> mainThreadCallback) {
        return new MainThreadCallback<T>() {
            ...
            private Runnable mMainThreadRunnable = new C02531();
            ...
            class C02531 implements Runnable {
                ...
                public void run() {
                    SyncQueueItem next = C02541.this.mQueue.next();
                    while (next != null) {
                        switch (next.what) {
                            case 1:
    ...
    public BackgroundCallback<T> getBackgroundProxy(final BackgroundCallback<T> backgroundCallback) {
        return new BackgroundCallback<T>() {
            ...
            private Runnable mBackgroundRunnable = new C02551();
            ...
            class C02551 implements Runnable {
                ...
                public void run() {
                    while (true) {
                        SyncQueueItem next = C02562.this.mQueue.next();
                        if (next != null) {
                            switch (next.what) {
                                case 1:
                                    C02562.this.mQueue.removeMessages(1);
                                    backgroundCallback.refresh(next.arg1);
                                    break;
                                case 2:
                                    C02562.this.mQueue.removeMessages(2);
                                    C02562.this.mQueue.removeMessages(3);
                        ...
                        C02562.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
