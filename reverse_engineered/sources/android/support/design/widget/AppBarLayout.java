...
public class AppBarLayout extends LinearLayout {
    ...
    class C00151 implements OnApplyWindowInsetsListener {
        C00151() {
        }
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        protected static class SavedState extends AbsSavedState {
            public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C00171());
            boolean firstVisibleChildAtMinimumHeight;
            int firstVisibleChildIndex;
            float firstVisibleChildPercentageShown;

            /* renamed from: android.support.design.widget.AppBarLayout$Behavior$SavedState$1 */
            static class C00171 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C00171() {
                }
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, int i) {
            ...
            if (pendingAction != 0) {
                ...
                if (this.mOffsetToChildIndexOnLayoutIsMinHeight) {
                    ...
                    i2 = Math.round(((float) childAt.getHeight()) * this.mOffsetToChildIndexOnLayoutPerc) + pendingAction;
                }
    ...
    public static class LayoutParams extends android.widget.LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0010R.styleable.AppBarLayout_Layout);
            this.mScrollFlags = obtainStyledAttributes.getInt(C0010R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (obtainStyledAttributes.hasValue(C0010R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.mScrollInterpolator = AnimationUtils.loadInterpolator(context, obtainStyledAttributes.getResourceId(C0010R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0010R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(obtainStyledAttributes.getDimensionPixelSize(C0010R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            obtainStyledAttributes.recycle();
        }
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            ViewUtilsLollipop.setStateListAnimatorFromAttrs(this, attributeSet, 0, C0010R.style.Widget_Design_AppBarLayout);
        }
        ...
        if (VERSION.SDK_INT >= 21 && obtainStyledAttributes.hasValue(C0010R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, (float) obtainStyledAttributes.getDimensionPixelSize(C0010R.styleable.AppBarLayout_elevation, 0));
        }
        obtainStyledAttributes.recycle();
        ViewCompat.setOnApplyWindowInsetsListener(this, new C00151());
    }
    ...
    protected int[] onCreateDrawableState(int i) {
        ...
        iArr[0] = this.mCollapsible ? C0010R.attr.state_collapsible : -C0010R.attr.state_collapsible;
        int i2 = (this.mCollapsible && this.mCollapsed) ? C0010R.attr.state_collapsed : -C0010R.attr.state_collapsed;
        iArr[1] = i2;
