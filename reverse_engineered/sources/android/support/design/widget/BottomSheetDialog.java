...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C00222 extends BottomSheetCallback {
        C00222() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int i) {
        ...
        this.mBottomSheetCallback = new C00222();
    ...
    private View wrapInBottomSheet(int i, View view, LayoutParams layoutParams) {
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) View.inflate(getContext(), C0010R.layout.design_bottom_sheet_dialog, null);
        if (i != 0 && view == null) {
            view = getLayoutInflater().inflate(i, coordinatorLayout, false);
        }
        FrameLayout frameLayout = (FrameLayout) coordinatorLayout.findViewById(C0010R.id.design_bottom_sheet);
        ...
        coordinatorLayout.findViewById(C0010R.id.touch_outside).setOnClickListener(new C00211());
    ...
    private static int getThemeResId(Context context, int i) {
        ...
        if (context.getTheme().resolveAttribute(C0010R.attr.bottomSheetDialogTheme, typedValue, true)) {
