...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C00351());
        public Bundle menuState;

        /* renamed from: android.support.design.widget.NavigationView$SavedState$1 */
        static class C00351 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C00351() {
            }
    ...
    public NavigationView(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0010R.styleable.NavigationView, i, C0010R.style.Widget_Design_NavigationView);
        ...
        if (obtainStyledAttributes.hasValue(C0010R.styleable.NavigationView_itemTextAppearance)) {
            resourceId = obtainStyledAttributes.getResourceId(C0010R.styleable.NavigationView_itemTextAppearance, 0);
            int i2 = 1;
        } else {
            resourceId = 0;
            boolean z = false;
        ...
        this.mMenu.setCallback(new C00341());
    ...
    protected void onMeasure(int i, int i2) {
        switch (MeasureSpec.getMode(i)) {
            case Integer.MIN_VALUE:
                i = MeasureSpec.makeMeasureSpec(Math.min(MeasureSpec.getSize(i), this.mMaxWidth), Ints.MAX_POWER_OF_TWO);
                break;
            case 0:
    ...
    private ColorStateList createDefaultColorStateList(int i) {
        ...
        if (!getContext().getTheme().resolveAttribute(C0246R.attr.colorPrimary, typedValue, true)) {
            return null;
        }
