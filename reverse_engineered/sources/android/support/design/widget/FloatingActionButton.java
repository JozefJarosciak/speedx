...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    public static class Behavior extends android.support.design.widget.CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        public Behavior(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0010R.styleable.FloatingActionButton_Behavior_Layout);
            this.mAutoHideEnabled = obtainStyledAttributes.getBoolean(C0010R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, true);
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mBackgroundTintMode = ViewUtils.parseTintMode(obtainStyledAttributes.getInt(C0010R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
        this.mRippleColor = obtainStyledAttributes.getColor(C0010R.styleable.FloatingActionButton_rippleColor, 0);
        this.mSize = obtainStyledAttributes.getInt(C0010R.styleable.FloatingActionButton_fabSize, -1);
        ...
        this.mCompatPadding = obtainStyledAttributes.getBoolean(C0010R.styleable.FloatingActionButton_useCompatPadding, false);
        obtainStyledAttributes.recycle();
    ...
    private int getSizeDimension(int i) {
        ...
        switch (i) {
            ...
            case 1:
                return resources.getDimensionPixelSize(C0010R.dimen.design_fab_size_mini);
            default:
                return resources.getDimensionPixelSize(C0010R.dimen.design_fab_size_normal);
        }
    }
