...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (MeasureSpec.getMode(i) == Ints.MAX_POWER_OF_TWO && TabLayout.this.mMode == 1 && TabLayout.this.mTabGravity == 1) {
                int childCount = getChildCount();
                int i3 = 0;
                int i4 = 0;
                while (i3 < childCount) {
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        final void update() {
            ...
            if (this.mCustomView == null) {
                if (this.mIconView == null) {
                    ImageView imageView = (ImageView) LayoutInflater.from(getContext()).inflate(C0010R.layout.design_layout_tab_icon, this, false);
                    addView(imageView, 0);
    ...
    public TabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(this.mTabTextAppearance, C0246R.styleable.TextAppearance);
        try {
            this.mTabTextSize = (float) obtainStyledAttributes2.getDimensionPixelSize(C0246R.styleable.TextAppearance_android_textSize, 0);
            this.mTabTextColors = obtainStyledAttributes2.getColorStateList(C0246R.styleable.TextAppearance_android_textColor);
            ...
            this.mRequestedTabMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0010R.styleable.TabLayout_tabMinWidth, -1);
            this.mRequestedTabMaxWidth = obtainStyledAttributes.getDimensionPixelSize(C0010R.styleable.TabLayout_tabMaxWidth, -1);
            ...
            this.mTabTextMultiLineSize = (float) resources.getDimensionPixelSize(C0010R.dimen.design_tab_text_size_2line);
            this.mScrollableTabMinWidth = resources.getDimensionPixelSize(C0010R.dimen.design_tab_scrollable_min_width);
            applyModeAndGravity();
        } finally {
        ...
        if (i != -1) {
            ...
            if (scrollX != calculateScrollXForTab) {
                if (this.mScrollAnimator == null) {
                    ...
                    this.mScrollAnimator.addUpdateListener(new C00501());
                }
