...
public class NavigationMenuItemView extends ForegroundLinearLayout implements ItemView {
    ...
    class C00111 extends AccessibilityDelegateCompat {
        C00111() {
        }
    ...
    public NavigationMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mAccessibilityDelegate = new C00111();
        setOrientation(0);
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (!getContext().getTheme().resolveAttribute(C0246R.attr.colorControlHighlight, typedValue, true)) {
            return null;
        }
