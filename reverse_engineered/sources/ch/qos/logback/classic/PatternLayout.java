...
public class PatternLayout extends PatternLayoutBase<ILoggingEvent> {
    ...
    static {
        ...
        defaultConverterMap.put(AVStatus.MESSAGE_TAG, MessageConverter.class.getName());
        defaultConverterMap.put("C", ClassOfCallerConverter.class.getName());
        defaultConverterMap.put(Action.CLASS_ATTRIBUTE, ClassOfCallerConverter.class.getName());
        defaultConverterMap.put("M", MethodOfCallerConverter.class.getName());
        defaultConverterMap.put(C0861d.f2145q, MethodOfCallerConverter.class.getName());
        defaultConverterMap.put("L", LineOfCallerConverter.class.getName());
        defaultConverterMap.put(Property.SYMBOL_PLACEMENT_LINE, LineOfCallerConverter.class.getName());
