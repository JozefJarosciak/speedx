...
public class Wechat extends Platform {
    ...
    class C06881 implements AuthorizeListener {
        /* renamed from: a */
        final /* synthetic */ Wechat f1641a;

        C06881(Wechat wechat) {
            this.f1641a = wechat;
        }

        public void onError(Throwable th) {
            if (this.f1641a.listener != null) {
                this.f1641a.listener.onError(this.f1641a, 1, th);
            }
        }

        public void onComplete(Bundle bundle) {
            this.f1641a.afterRegister(1, null);
        }

        public void onCancel() {
            if (this.f1641a.listener != null) {
                this.f1641a.listener.onCancel(this.f1641a, 1);
            }
        }
    }
    ...
    protected void initDevInfo(String str) {
        this.f1642a = getDevinfo(C0861d.f2134f);
        this.f1643b = getDevinfo("AppSecret");
        this.f1644c = "true".equals(getDevinfo("BypassApproval"));
        if (this.f1642a == null || this.f1642a.length() <= 0) {
            this.f1642a = getDevinfo("WechatMoments", C0861d.f2134f);
            this.f1644c = "true".equals(getDevinfo("WechatMoments", "BypassApproval"));
            if (this.f1642a == null || this.f1642a.length() <= 0) {
                this.f1642a = getDevinfo("WechatFavorite", C0861d.f2134f);
                if (this.f1642a != null && this.f1642a.length() > 0) {
    ...
    protected void setNetworkDevinfo() {
        this.f1642a = getNetworkDevinfo("app_id", C0861d.f2134f);
        this.f1643b = getNetworkDevinfo("app_secret", "AppSecret");
        if (this.f1642a == null || this.f1642a.length() <= 0) {
            this.f1642a = getNetworkDevinfo(23, "app_id", C0861d.f2134f);
            if (this.f1642a == null || this.f1642a.length() <= 0) {
                this.f1642a = getNetworkDevinfo(37, "app_id", C0861d.f2134f);
                if (this.f1642a != null && this.f1642a.length() > 0) {
        ...
        if (this.f1643b == null || this.f1643b.length() <= 0) {
            this.f1643b = getNetworkDevinfo(23, "app_secret", "AppSecret");
            if (this.f1643b == null || this.f1643b.length() <= 0) {
                this.f1643b = getNetworkDevinfo(37, "app_secret", "AppSecret");
                if (this.f1643b != null && this.f1643b.length() > 0) {
                    copyNetworkDevinfo(37, 22);
                    this.f1643b = getNetworkDevinfo("app_secret", "AppSecret");
                    C0621d.m2279a().d("Try to use the dev info of WechatFavorite, this will cause Id and SortId field are always 0.", new Object[0]);
    ...
    protected void doAuthorize(String[] strArr) {
        if (!TextUtils.isEmpty(this.f1642a) && !TextUtils.isEmpty(this.f1643b)) {
            WechatHelper a = WechatHelper.m2681a();
            a.m2704a(this.context, this.f1642a);
            if (a.m2708c()) {
                C0701g c0701g = new C0701g(this, 22);
                c0701g.m2742a(this.f1642a, this.f1643b);
                C0703i c0703i = new C0703i(this);
                c0703i.m2758a(c0701g);
                c0703i.m2756a(new C06881(this));
                try {
                    a.m2702a(c0703i);
                } catch (Throwable th) {
