...
public class WXMusicObject implements IMediaObject {
    ...
    public boolean checkArgs() {
        if (TextUtils.isEmpty(this.musicUrl) && TextUtils.isEmpty(this.musicLowBandUrl)) {
            C0621d.m2279a().d("both musicUrl and musicLowBandUrl are null", new Object[0]);
            return false;
        } else if (this.musicUrl != null && this.musicUrl.length() > 10240) {
            C0621d.m2279a().d("checkArgs fail, musicUrl is too long", new Object[0]);
            return false;
        } else if (this.musicLowBandUrl == null || this.musicLowBandUrl.length() <= 10240) {
            return true;
        } else {
            C0621d.m2279a().d("checkArgs fail, musicLowBandUrl is too long", new Object[0]);
            return false;
        }
    }
}
