...
public interface DatabaseConnection {
    ...
    CompiledStatement compileStatement(String str, StatementBuilder$StatementType statementBuilder$StatementType, FieldType[] fieldTypeArr, int i) throws SQLException;
