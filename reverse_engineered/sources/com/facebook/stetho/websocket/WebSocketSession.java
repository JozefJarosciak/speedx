...
class WebSocketSession implements SimpleSession {
    ...
    private final WriteCallback mErrorForwardingWriteCallback = new C31842();
    private AtomicBoolean mIsOpen = new AtomicBoolean(false);
    private final ReadCallback mReadCallback = new C31831();
    ...
    class C31831 implements ReadCallback {
        C31831() {
        }
    ...
    class C31842 implements WriteCallback {
        C31842() {
        }
