...
public class LocalSocketServer {
    ...
    private static class WorkerThread extends Thread {
        ...
        public void run() {
            try {
                ...
                LogUtil.m15289w("I/O error: %s", e2);
                try {
                    this.mSocket.close();
    ...
    private void listenOnAddress(String str) throws IOException {
        ...
        LogUtil.m15280i("Listening on @" + str);
        while (!Thread.interrupted()) {
            try {
                Thread workerThread = new WorkerThread(this.mServerSocket.accept(), this.mSocketHandler);
                ...
                LogUtil.m15290w(e, "I/O error");
            } catch (InterruptedIOException e2) {
            } catch (Throwable e3) {
                LogUtil.m15290w(e3, "I/O error initialising connection thread");
            }
        }
        LogUtil.m15280i("Server shutdown on @" + str);
    }
    ...
    private static LocalServerSocket bindToSocket(String str) throws IOException {
        ...
        while (true) {
            try {
                ...
                e = e2;
                LogUtil.m15290w(e, "Binding error, sleep 1000 ms...");
                if (th != null) {
                    e = th;
                }
        ...
        if (LogUtil.isLoggable(3)) {
            LogUtil.m15272d("Trying to bind to @" + str);
        }
