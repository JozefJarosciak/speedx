...
public class MethodInvoker {
    ...
    private static abstract class TypedMethodInvoker<T> {
        ...
        boolean invoke(Object obj, String str, String str2) {
            try {
                ...
                LogUtil.m15288w("InvocationTargetException: " + e2.getMessage());
            } catch (IllegalAccessException e3) {
                LogUtil.m15288w("IllegalAccessException: " + e3.getMessage());
            } catch (IllegalArgumentException e4) {
                LogUtil.m15288w("IllegalArgumentException: " + e4.getMessage());
            }
            return false;
        }
    }
    ...
    public void invoke(Object obj, String str, String str2) {
        ...
        LogUtil.m15288w("Method with name " + str + " not found for any of the MethodInvoker supported argument types.");
    }
}
