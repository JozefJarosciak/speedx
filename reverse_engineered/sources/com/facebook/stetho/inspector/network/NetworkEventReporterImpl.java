...
public class NetworkEventReporterImpl implements NetworkEventReporter {
    ...
    public void requestWillBeSent(InspectorRequest inspectorRequest) {
        ...
        if (peerManagerIfEnabled != null) {
            ...
            requestWillBeSentParams.frameId = C0844a.f2048d;
            requestWillBeSentParams.loaderId = C0844a.f2048d;
    ...
    public void responseHeadersReceived(InspectorResponse inspectorResponse) {
        ...
        if (peerManagerIfEnabled != null) {
            ...
            responseReceivedParams.frameId = C0844a.f2048d;
            responseReceivedParams.loaderId = C0844a.f2048d;
