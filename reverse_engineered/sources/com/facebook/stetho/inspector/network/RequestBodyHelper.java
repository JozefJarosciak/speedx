...
public class RequestBodyHelper {
    ...
    public OutputStream createBodySink(String str) throws IOException {
        ...
        OutputStream create = AsyncHttpClient.ENCODING_GZIP.equals(str) ? GunzippingOutputStream.create(byteArrayOutputStream) : "deflate".equals(str) ? new InflaterOutputStream(byteArrayOutputStream) : byteArrayOutputStream;
