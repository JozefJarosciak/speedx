...
*/
    ...
    L_0x0033:
        r1 = new com.facebook.stetho.inspector.protocol.module.DOMStorage$DOMStorageAssignmentException;	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r6 = new java.lang.StringBuilder;	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r6.<init>();	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r7 = "Unsupported: cannot add new key ";	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r6 = r6.append(r7);	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r6 = r6.append(r2);	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r7 = " due to lack of type inference";	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r6 = r6.append(r7);	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r6 = r6.toString();	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r1.<init>(r6);	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        throw r1;	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
    L_0x0052:
        r1 = move-exception;
    ...
    L_0x006f:
        return;
    L_0x0070:
        r1 = r4.edit();	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
    ...
    L_0x007f:
        r1 = move-exception;
        r1 = new com.facebook.stetho.inspector.protocol.module.DOMStorage$DOMStorageAssignmentException;	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r6 = java.util.Locale.US;	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r7 = "Type mismatch setting %s to %s (expected %s)";	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r8 = 3;	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r8 = new java.lang.Object[r8];	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r9 = 0;	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r8[r9] = r2;	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r9 = 1;	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r8[r9] = r3;	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r9 = 2;	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r10 = r5.getClass();	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r10 = r10.getSimpleName();	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r8[r9] = r10;	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r6 = java.lang.String.format(r6, r7, r8);	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        r1.<init>(r6);	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
        throw r1;	 Catch:{ DOMStorage$DOMStorageAssignmentException -> 0x0052 }
    L_0x00a2:
        r1 = r11.mDOMStoragePeerManager;
