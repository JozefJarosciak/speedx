...
final class DOM$DocumentUpdateListener implements UpdateListener {
    ...
    public void onInspectRequested(Object obj) {
        ...
        if (nodeIdForElement == null) {
            LogUtil.m15273d("DocumentProvider.Listener.onInspectRequested() called for a non-mapped node: element=%s", obj);
            return;
        }
