...
public class Page implements ChromeDevtoolsDomain {
    ...
    private void notifyExecutionContexts(JsonRpcPeer jsonRpcPeer) {
        ...
        executionContextDescription.frameId = C0844a.f2048d;
    ...
    public JsonRpcResult getResourceTree(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        FrameResourceTree createSimpleFrameResourceTree = createSimpleFrameResourceTree(C0844a.f2048d, null, "Stetho", it.hasNext() ? (String) it.next() : "");
        ...
        while (it.hasNext()) {
            ...
            createSimpleFrameResourceTree.childFrames.add(createSimpleFrameResourceTree(stringBuilder, C0844a.f2048d, "Child #" + stringBuilder, (String) it.next()));
            i = i2;
        }
