...
public final class Stetho$DefaultInspectorModulesBuilder {
    ...
    public Stetho$DefaultInspectorModulesBuilder provideDatabaseDriver(Database$DatabaseDriver database$DatabaseDriver) {
        ...
        if (VERSION.SDK_INT >= 11) {
            ...
            if (this.mDatabaseDrivers != null) {
                ...
                for (Database$DatabaseDriver database$DatabaseDriver : this.mDatabaseDrivers) {
                    Object obj2;
                    database.add(database$DatabaseDriver);
                    if (database$DatabaseDriver instanceof SqliteDatabaseDriver) {
                        obj2 = 1;
                    } else {
                        obj2 = obj;
                    }
