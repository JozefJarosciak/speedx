...
/* compiled from: Blur */
/* renamed from: com.beastbikes.android.widget.a.a */
public class C2605a {
    @SuppressLint({"NewApi"})
    /* renamed from: a */
    public static Bitmap m12997a(Context context, Bitmap bitmap, int i) {
        try {
            Bitmap copy;
            ...
            for (i7 = 0; i7 < width; i7++) {
                ...
                for (i8 = 0; i8 < height; i8++) {
                    iArr[i11] = (((ViewCompat.MEASURED_STATE_MASK & iArr[i11]) | (iArr6[i19] << 16)) | (iArr6[i12] << 8)) | iArr6[i9];
                    i19 -= i6;
                    i12 -= i5;
                    i9 -= i4;
