...
/* compiled from: IFEarlybirdFilter */
/* renamed from: com.beastbikes.android.modules.user.filter.a.d */
public class C2421d extends C2417g {
    ...
    /* renamed from: l */
    private void m12286l() {
        m12279a((int) C1373R.drawable.earlybird_curves);
        m12279a((int) C1373R.drawable.earlybird_overlay_map);
        m12279a((int) C1373R.drawable.vignette_map);
        m12279a((int) C1373R.drawable.earlybird_blowout);
        m12279a((int) C1373R.drawable.earlybird_map);
    }
}
