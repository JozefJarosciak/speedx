...
/* compiled from: IFToasterFilter */
/* renamed from: com.beastbikes.android.modules.user.filter.a.o */
public class C2436o extends C2417g {
    public C2436o(Context context) {
    ...
    /* renamed from: l */
    private void m12296l() {
        m12279a((int) C1373R.drawable.toaster_metal);
        m12279a((int) C1373R.drawable.toaster_soft_light);
        m12279a((int) C1373R.drawable.toaster_curves);
        m12279a((int) C1373R.drawable.toaster_overlay_map_warm);
        m12279a((int) C1373R.drawable.toaster_color_shift);
    }
}
