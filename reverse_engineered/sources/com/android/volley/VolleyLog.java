...
public class VolleyLog {
    ...
    static class MarkerLog {
        ...
        public synchronized void finish(String str) {
            ...
            if (getTotalDuration() > 0) {
                ...
                VolleyLog.m3502d("(%-4d ms) %s", Long.valueOf(r2), str);
                long j2 = j;
                for (Marker marker : this.mMarkers) {
                    VolleyLog.m3502d("(+%-4d) [%2d] %s", Long.valueOf(marker.time - j2), Long.valueOf(marker.thread), marker.name);
                    j2 = marker.time;
                }
            }
        }
        ...
        protected void finalize() throws Throwable {
            if (!this.mFinished) {
                ...
                VolleyLog.m3503e("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
            }
        }
    ...
    public static void setTag(String str) {
        m3502d("Changing log tag to %s", str);
        TAG = str;
        DEBUG = Log.isLoggable(TAG, 2);
    }

    /* renamed from: v */
    public static void m3505v(String str, Object... objArr) {
        if (DEBUG) {
    ...
    /* renamed from: d */
    public static void m3502d(String str, Object... objArr) {
        Log.d(TAG, buildMessage(str, objArr));
    }

    /* renamed from: e */
    public static void m3503e(String str, Object... objArr) {
        Log.e(TAG, buildMessage(str, objArr));
    }

    /* renamed from: e */
    public static void m3504e(Throwable th, String str, Object... objArr) {
