...
public class NetworkHelper {
    ...
    public static final class SimpleX509TrustManager implements X509TrustManager {
        ...
        public SimpleX509TrustManager(KeyStore keyStore) {
            try {
                ...
                MobLog.getInstance().m16933d("failed to initialize the standard trust manager: " + e.getMessage(), new Object[0]);
    ...
    public String httpGet(String str, ArrayList<KVPair<String>> arrayList, ArrayList<KVPair<String>> arrayList2, NetworkTimeOut networkTimeOut) throws Throwable {
        ...
        MobLog.getInstance().m16939i("httpGet: " + str, new Object[0]);
        if (arrayList != null) {
        ...
        if (responseCode == 200) {
            ...
            MobLog.getInstance().m16939i("use time: " + (System.currentTimeMillis() - currentTimeMillis), new Object[0]);
            return kvPairsToUrl;
        }
        ...
        hashMap.put("error", stringBuilder2.toString());
    ...
    public String downloadCache(Context context, String str, String str2, boolean z, NetworkTimeOut networkTimeOut) throws Throwable {
        long currentTimeMillis = System.currentTimeMillis();
        MobLog.getInstance().m16939i("downloading: " + str, new Object[0]);
        if (z) {
            File file = new File(C4275R.getCachePath(context, str2), Data.MD5(str));
            if (z && file.exists()) {
                MobLog.getInstance().m16939i("use time: " + (System.currentTimeMillis() - currentTimeMillis), new Object[0]);
        ...
        if (responseCode == 200) {
            ...
            if (headerFields != null) {
                ...
                if (list != null && list.size() > 0) {
                    str3 = null;
                    for (String str4 : ((String) list.get(0)).split(C0880h.f2220b)) {
                    ...
                    file2 = new File(C4275R.getCachePath(context, str2), str3);
                    if (z || !file2.exists()) {
    ...
    public void rawGet(String str, ArrayList<KVPair<String>> arrayList, RawNetworkCallback rawNetworkCallback, NetworkTimeOut networkTimeOut) throws Throwable {
        long currentTimeMillis = System.currentTimeMillis();
        MobLog.getInstance().m16939i("rawGet: " + str, new Object[0]);
        HttpURLConnection connection = getConnection(str, networkTimeOut);
        if (arrayList != null) {
    ...
    public void rawGet(java.lang.String r8, com.mob.tools.network.HttpResponseCallback r9, com.mob.tools.network.NetworkHelper.NetworkTimeOut r10) throws java.lang.Throwable {
        /*
        r7 = this;
        r6 = 0;
    ...
    public String jsonPost(String str, ArrayList<KVPair<String>> arrayList, ArrayList<KVPair<String>> arrayList2, NetworkTimeOut networkTimeOut) throws Throwable {
        long currentTimeMillis = System.currentTimeMillis();
        MobLog.getInstance().m16939i("jsonPost: " + str, new Object[0]);
        HttpURLConnection connection = getConnection(str, networkTimeOut);
        connection.setDoOutput(true);
        connection.setChunkedStreamingMode(0);
        connection.setRequestProperty(C0861d.f2132d, "application/json");
        if (arrayList2 != null) {
            Iterator it = arrayList2.iterator();
            while (it.hasNext()) {
                KVPair kVPair = (KVPair) it.next();
        ...
        hashMap2.put("error", stringBuilder2.toString());
        ...
        httpPost(str, arrayList, arrayList2, arrayList3, i, new HttpResponseCallback() {
            public void onResponse(HttpConnection httpConnection) throws Throwable {
                ...
                if (responseCode == 200 || responseCode == 201) {
                    ...
                    bufferedReader.close();
                    hashMap.put("resp", stringBuilder.toString());
                    return;
                }
                StringBuilder stringBuilder2 = new StringBuilder();
    ...
    private HTTPPart getFilePostHTTPPart(HttpURLConnection httpURLConnection, String str, ArrayList<KVPair<String>> arrayList, ArrayList<KVPair<String>> arrayList2) throws Throwable {
        ...
        while (it.hasNext()) {
            ...
            stringPart3.append(HelpFormatter.DEFAULT_LONG_OPT_PREFIX).append(uuid).append("\r\n");
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void rawPost(java.lang.String r9, java.util.ArrayList<com.mob.tools.network.KVPair<java.lang.String>> r10, com.mob.tools.network.HTTPPart r11, com.mob.tools.network.HttpResponseCallback r12, com.mob.tools.network.NetworkHelper.NetworkTimeOut r13) throws java.lang.Throwable {
        /*
        r8 = this;
        r7 = 0;
        r2 = java.lang.System.currentTimeMillis();
    ...
    public String httpPut(String str, ArrayList<KVPair<String>> arrayList, KVPair<String> kVPair, ArrayList<KVPair<String>> arrayList2, NetworkTimeOut networkTimeOut) throws Throwable {
        String kvPairsToUrl;
        long currentTimeMillis = System.currentTimeMillis();
        MobLog.getInstance().m16939i("httpPut: " + str, new Object[0]);
        if (arrayList != null) {
            kvPairsToUrl = kvPairsToUrl(arrayList);
            if (kvPairsToUrl.length() > 0) {
                str = str + CallerData.NA + kvPairsToUrl;
    ...
    public ArrayList<KVPair<String[]>> httpHead(String str, ArrayList<KVPair<String>> arrayList, KVPair<String> kVPair, ArrayList<KVPair<String>> arrayList2, NetworkTimeOut networkTimeOut) throws Throwable {
        long currentTimeMillis = System.currentTimeMillis();
        MobLog.getInstance().m16939i("httpHead: " + str, new Object[0]);
        if (arrayList != null) {
    ...
    private String kvPairsToUrl(ArrayList<KVPair<String>> arrayList) throws Throwable {
        ...
        while (it.hasNext()) {
            ...
            String urlEncode2 = kVPair.value != null ? Data.urlEncode((String) kVPair.value, "utf-8") : "";
            if (stringBuilder.length() > 0) {
                stringBuilder.append('&');
            }
