...
public class MobViewPager extends ViewGroup {
    ...
    class C42631 implements Interpolator {
    ...
    private void init(Context context) {
        this.scroller = new Scroller(getContext(), new C42631());
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.adapter != null && this.screenCount > 0) {
            ...
            measuredHeight = MeasureSpec.makeMeasureSpec(measuredHeight, Ints.MAX_POWER_OF_TWO);
            for (measuredWidth = 0; measuredWidth < getChildCount(); measuredWidth++) {
    ...
    private void onScreenChange(int i) {
        if (this.adapter != null) {
            ...
            if (this.currentScreen > i) {
                for (i2 = 0; i2 < this.currentScreen - i; i2++) {
                    i3 = (i + i2) + 1;
                ...
                for (i2 = 0; i2 < i - this.currentScreen; i2++) {
                    i3 = (i - i2) - 1;
                    view = this.nextPage;
