...
public class ScaledImageView extends ImageView implements OnTouchListener {
    ...
    public void setBitmap(Bitmap bitmap) {
        ...
        float[] fArr = new float[]{((float) fixRect[0]) / ((float) iArr[0]), ((float) fixRect[1]) / ((float) iArr[1])};
                    ...
                    if (this.mode != 1) {
                        if (this.mode != 2) {
                            if (this.mode == 3) {
                                ...
                                float[] fArr3 = new float[]{(fArr[0] + fArr2[0]) / 2.0f, (fArr[1] + fArr2[1]) / 2.0f};
    ...
    public void rotateLeft() {
        try {
            ...
            float[] fArr2 = new float[]{fArr[0] * ((float) this.bitmap.getWidth()), fArr[4] * ((float) this.bitmap.getHeight())};
            float[] fArr3 = new float[]{(((float) iArr[0]) - fArr2[0]) / 2.0f, (((float) iArr[1]) - fArr2[1]) / 2.0f};
            fArr[2] = fArr3[0];
            fArr[5] = fArr3[1];
            this.matrix.setValues(fArr);
            if (this.listener != null) {
    ...
    public Bitmap getCropedBitmap(Rect rect) {
        try {
            ...
            if (captureView == null) {
                MobLog.getInstance().m16945w("ivPhoto.getDrawingCache() returns null", new Object[0]);
                return null;
            }
