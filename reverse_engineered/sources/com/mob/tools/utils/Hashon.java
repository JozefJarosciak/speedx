...
public class Hashon {
    public <T> HashMap<String, T> fromJson(String str) {
        ...
        try {
            if (str.startsWith("[") && str.endsWith("]")) {
                str = "{\"fakelist\":" + str + C0880h.f2222d;
            }
            return fromJson(new JSONObject(str));
        } catch (Throwable th) {
            MobLog.getInstance().m16945w(str, new Object[0]);
    ...
    private String format(String str, HashMap<String, Object> hashMap) {
        ...
        for (Entry entry : hashMap.entrySet()) {
            ...
            stringBuffer.append(str2).append(CoreConstants.DOUBLE_QUOTE_CHAR).append((String) entry.getKey()).append("\":");
            Object value = entry.getValue();
            if (value instanceof HashMap) {
                ...
                stringBuffer.append(CoreConstants.DOUBLE_QUOTE_CHAR).append(value).append(CoreConstants.DOUBLE_QUOTE_CHAR);
            } else {
                stringBuffer.append(value);
            }
            i++;
        }
        stringBuffer.append('\n').append(str).append(CoreConstants.CURLY_RIGHT);
    ...
    private String format(String str, ArrayList<Object> arrayList) {
        ...
        while (it.hasNext()) {
            ...
            if (next instanceof HashMap) {
                ...
                stringBuffer.append(CoreConstants.DOUBLE_QUOTE_CHAR).append(next).append(CoreConstants.DOUBLE_QUOTE_CHAR);
            } else {
