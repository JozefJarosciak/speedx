...
public class SQLiteHelper {
        ...
        private void open() {
            if (this.db == null) {
                ...
                if (i != 0) {
                    ...
                    stringBuilder.append("create table  ").append(this.name).append("(");
                    for (Entry entry : this.fieldTypes.entrySet()) {
                        ...
                        if (equals) {
                            z = this.primaryAutoincrement;
                        } else {
                            z = false;
                        }
                        stringBuilder.append(str).append(" ").append(str2);
                        stringBuilder.append(booleanValue ? " not null" : "");
                        stringBuilder.append(equals ? " primary key" : "");
                        stringBuilder.append(z ? " autoincrement," : ",");
                    }
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static int getSize(com.mob.tools.utils.SQLiteHelper.SingleTableDB r5) throws java.lang.Throwable {
        /*
        r1 = 0;
        r0 = 0;
        r5.open();
