...
public class C1102f extends Service {
    ...
    private boolean readConf(File file) {
        boolean z = false;
        try {
            File file2 = new File(C1100j.m4025g() + "/grtcfrsa.dat");
            if (file2.exists()) {
                ...
                if (randomAccessFile.readBoolean() && randomAccessFile.readBoolean()) {
                    ...
                    if (readInt != 0) {
                        ...
                        if (!(str == null || a == null || !C1100j.m4018b(a, str, "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCiP7BS5IjEOzrKGR9/Ww9oSDhdX1ir26VOsYjT1T6tk2XumRpkHRwZbrucDcNnvSB4QsqiEJnvTSRi7YMbh2H9sLMkcvHlMV5jAErNvnuskWfcvf7T2mq7EUZI/Hf4oVZhHV0hQJRFVdTcjWI6q2uaaKM3VMh+roDesiE7CR2biQIDAQAB"))) {
                            z = true;
                        }
                    }
                }
    ...
    public void onCreate() {
        ...
        this.libNat = new C1088a();
        try {
            File file = new File(C1100j.m4025g() + File.separator + replaceFileName);
            File file2 = new File(C1100j.m4025g() + File.separator + jarFileName);
            if (file.exists()) {
                if (file2.exists()) {
                    file2.delete();
                }
            ...
            if (file2.exists() && readConf(new File(C1100j.m4025g() + File.separator + jarFileName))) {
                this.libJar = (LLSInterface) new DexClassLoader(C1100j.m4025g() + File.separator + jarFileName, C1100j.m4025g(), null, getClassLoader()).loadClass("com.baidu.serverLoc.LocationService").newInstance();
            }
        } catch (Exception e) {
            this.libJar = null;
        }
