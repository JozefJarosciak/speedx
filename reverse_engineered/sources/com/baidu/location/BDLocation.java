...
public final class BDLocation implements Parcelable {
    ...
    public static final Creator<BDLocation> CREATOR = new C1071a();
    ...
    public BDLocation(String str) {
        ...
        if (str != null && !str.equals("")) {
            try {
                ...
                JSONObject jSONObject2 = jSONObject.getJSONObject(C0882j.f2229c);
                ...
                if (parseInt == 61) {
                    ...
                    jSONObject = jSONObject3.getJSONObject(Property.SYMBOL_PLACEMENT_POINT);
                    ...
                    setDirection(Float.parseFloat(jSONObject3.getString(DateTokenConverter.CONVERTER_KEY)));
                    ...
                    jSONObject = jSONObject4.getJSONObject(Property.SYMBOL_PLACEMENT_POINT);
                    setLatitude(Double.parseDouble(jSONObject.getString("y")));
                    setLongitude(Double.parseDouble(jSONObject.getString("x")));
                    ...
                    if (jSONObject4.has("indoorflags")) {
                        try {
                            ...
                            if (jSONObject3.has("polygon")) {
                                setIndoorSurpportPolygon(jSONObject3.getString("polygon"));
                            }
                        } catch (Exception e3) {
                            e3.printStackTrace();
                        }
