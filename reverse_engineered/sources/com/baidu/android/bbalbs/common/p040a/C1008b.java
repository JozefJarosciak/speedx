...
public final class C1008b {
    ...
    public static String m3528a(byte[] bArr, String str) throws UnsupportedEncodingException {
        ...
        for (int i2 = 0; i2 < length2; i2 += 3) {
            int i3 = i + 1;
            bArr2[i] = f2250a[(bArr[i2] & 255) >> 2];
            i = i3 + 1;
            bArr2[i3] = f2250a[((bArr[i2] & 3) << 4) | ((bArr[i2 + 1] & 255) >> 4)];
            int i4 = i + 1;
            bArr2[i] = f2250a[((bArr[i2 + 1] & 15) << 2) | ((bArr[i2 + 2] & 255) >> 6)];
            i3 = i4 + 1;
            bArr2[i4] = f2250a[bArr[i2 + 2] & 63];
        ...
        switch (bArr.length % 3) {
            case 1:
                length = i + 1;
                bArr2[i] = f2250a[(bArr[length2] & 255) >> 2];
                i = length + 1;
                bArr2[length] = f2250a[(bArr[length2] & 3) << 4];
                i3 = i + 1;
                bArr2[i] = (byte) 61;
                length = i3 + 1;
                bArr2[i3] = (byte) 61;
            ...
            case 2:
                ...
                bArr2[i] = f2250a[(bArr[length2] & 255) >> 2];
                i = length + 1;
                bArr2[length] = f2250a[((bArr[length2] & 3) << 4) | ((bArr[length2 + 1] & 255) >> 4)];
                i3 = i + 1;
                bArr2[i] = f2250a[(bArr[length2 + 1] & 15) << 2];
                length = i3 + 1;
                bArr2[i3] = (byte) 61;
                break;
            default:
    ...
    /* renamed from: a */
    public static byte[] m3529a(byte[] bArr) {
        return C1008b.m3530a(bArr, bArr.length);
    }

    /* renamed from: a */
    public static byte[] m3530a(byte[] bArr, int i) {
        int i2 = (i / 4) * 3;
        if (i2 == 0) {
            return new byte[0];
        }
