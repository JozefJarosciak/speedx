...
public final class Detector {
    ...
    private static ResultPoint[] findRowsWithPattern(BitMatrix bitMatrix, int i, int i2, int i3, int i4, int[] iArr) {
        ...
        int i9 = i3;
        while (i9 < i) {
            int[] findGuardPattern = findGuardPattern(bitMatrix, i4, i9, i2, false, iArr, iArr3);
            if (findGuardPattern != null) {
                iArr2 = findGuardPattern;
                i5 = i9;
                while (i5 > 0) {
                    i9 = i5 - 1;
                    findGuardPattern = findGuardPattern(bitMatrix, i4, i9, i2, false, iArr, iArr3);
                    if (findGuardPattern == null) {
                        i5 = i9 + 1;
                        break;
                    }
                ...
                if (obj != null) {
                    ...
                    i9 = i5;
                    while (i9 < i) {
                        findGuardPattern = findGuardPattern(bitMatrix, iArr2[0], i9, i2, false, iArr, iArr3);
