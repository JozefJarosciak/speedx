...
final class GeneralAppIdDecoder {
    ...
    private boolean isStillIsoIec646(int i) {
        ...
        if (extractNumericValueFromBitArray >= 64 && extractNumericValueFromBitArray < AVException.OBJECT_TOO_LARGE) {
            return true;
        }
        ...
        if (extractNumericValueFromBitArray < 232 || extractNumericValueFromBitArray >= AVException.FILE_DOWNLOAD_INCONSISTENT_FAILURE) {
            z = false;
        }
        return z;
    }
    ...
    private DecodedChar decodeIsoIec646(int i) throws FormatException {
        ...
        if (extractNumericValueFromBitArray >= 90 && extractNumericValueFromBitArray < AVException.OBJECT_TOO_LARGE) {
