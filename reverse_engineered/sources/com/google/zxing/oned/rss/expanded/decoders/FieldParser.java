...
final class FieldParser {
    ...
    static {
        ...
        r0[12] = new Object[]{ANSIConstants.BLACK_FG, VARIABLE_LENGTH, Integer.valueOf(8)};
        r0[13] = new Object[]{ANSIConstants.WHITE_FG, VARIABLE_LENGTH, Integer.valueOf(8)};
    ...
    private static String processFixedAI(int i, int i2, String str) throws NotFoundException {
        ...
        substring = CoreConstants.LEFT_PARENTHESIS_CHAR + substring + CoreConstants.RIGHT_PARENTHESIS_CHAR + substring2;
    ...
    private static String processVariableAI(int i, int i2, String str) throws NotFoundException {
        ...
        String str2 = CoreConstants.LEFT_PARENTHESIS_CHAR + substring + CoreConstants.RIGHT_PARENTHESIS_CHAR + substring2;
