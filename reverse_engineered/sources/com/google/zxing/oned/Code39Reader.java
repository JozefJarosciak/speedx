...
public final class Code39Reader extends OneDReader {
    ...
    static final int[] CHARACTER_ENCODINGS = new int[]{52, 289, 97, 352, 49, HttpStatus.SC_NOT_MODIFIED, 112, 37, 292, 100, 265, 73, 328, 25, 280, 88, 13, 268, 76, 28, 259, 67, 322, 19, 274, 82, 7, 262, 70, 22, 385, Opcodes.INSTANCEOF, 448, Opcodes.I2B, HttpStatus.SC_BAD_REQUEST, AVException.ACCOUNT_ALREADY_LINKED, 133, 388, 196, Opcodes.LCMP, 168, 162, 138, 42};
    ...
    private static String decodeExtended(CharSequence charSequence) throws FormatException {
        ...
        while (i < length) {
            ...
            if (charAt == '+' || charAt == CoreConstants.DOLLAR || charAt == CoreConstants.PERCENT_CHAR || charAt == '/') {
