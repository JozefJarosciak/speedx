...
public final class CodaBarWriter extends OneDimensionalCodeWriter {
    ...
    private static final char[] CHARS_WHICH_ARE_TEN_LENGTH_EACH_AFTER_DECODED = new char[]{'/', CoreConstants.COLON_CHAR, '+', CoreConstants.DOT};
    ...
    public boolean[] encode(String str) {
        ...
        while (i2 < str.length() - 1) {
            if (Character.isDigit(str.charAt(i2)) || str.charAt(i2) == CoreConstants.DASH_CHAR || str.charAt(i2) == CoreConstants.DOLLAR) {
                i += 9;
            } else if (CodaBarReader.arrayContains(CHARS_WHICH_ARE_TEN_LENGTH_EACH_AFTER_DECODED, str.charAt(i2))) {
                i += 10;
            } else {
                throw new IllegalArgumentException("Cannot encode : '" + str.charAt(i2) + CoreConstants.SINGLE_QUOTE_CHAR);
            }
            i2++;
        }
