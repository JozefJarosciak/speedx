...
public final class Encoder {
    ...
    public static AztecCode encode(byte[] bArr, int i, int i2) {
        ...
        if (i2 != 0) {
            ...
            i3 = WORD_SIZE[abs];
            i7 = totalBitsInLayer - (totalBitsInLayer % i3);
            BitArray stuffBits = stuffBits(encode, i3);
            if (stuffBits.getSize() + size > i7) {
        ...
        while (totalBitsInLayer <= 32) {
            ...
            if (size2 <= abs) {
                ...
                int i8 = abs - (abs % i4);
                if ((!z3 || r2.getSize() <= i4 * 64) && r2.getSize() + size <= i8) {
                    totalBitsInLayer = i3;
                    i3 = abs;
                    z = z3;
                }
        ...
        if (z) {
            i5 = (totalBitsInLayer * 4) + 11;
        } else {
            i5 = (totalBitsInLayer * 4) + 14;
        }
        int[] iArr = new int[i5];
        if (z) {
            ...
            for (i3 = 0; i3 < i7; i3++) {
                size = (i3 / 15) + i3;
                iArr[(i7 - i3) - 1] = (i6 - size) - 1;
                iArr[i7 + i3] = (size + i6) + 1;
            }
        }
        BitMatrix bitMatrix = new BitMatrix(i4);
        size = 0;
        for (size2 = 0; size2 < totalBitsInLayer; size2++) {
            ...
            for (i6 = 0; i6 < i3; i6++) {
                int i9 = i6 * 2;
                for (i7 = 0; i7 < 2; i7++) {
                    if (generateCheckWords.get((size + i9) + i7)) {
                        bitMatrix.set(iArr[(size2 * 2) + i7], iArr[(size2 * 2) + i6]);
                    }
                    if (generateCheckWords.get((((i3 * 2) + size) + i9) + i7)) {
                        bitMatrix.set(iArr[(size2 * 2) + i6], iArr[((i5 - 1) - (size2 * 2)) - i7]);
                    }
                    if (generateCheckWords.get((((i3 * 4) + size) + i9) + i7)) {
                        bitMatrix.set(iArr[((i5 - 1) - (size2 * 2)) - i7], iArr[((i5 - 1) - (size2 * 2)) - i6]);
                    }
                    if (generateCheckWords.get((((i3 * 6) + size) + i9) + i7)) {
                        bitMatrix.set(iArr[((i5 - 1) - (size2 * 2)) - i6], iArr[(size2 * 2) + i7]);
                    }
                }
            }
            size = (i3 * 8) + size;
        }
        drawModeMessage(bitMatrix, z, i4, generateModeMessage);
        if (z) {
            drawBullsEye(bitMatrix, i4 / 2, 5);
        } else {
            drawBullsEye(bitMatrix, i4 / 2, 7);
            i7 = 0;
            i3 = 0;
            while (i7 < (i5 / 2) - 1) {
                for (i6 = (i4 / 2) & 1; i6 < i4; i6 += 2) {
                    bitMatrix.set((i4 / 2) - i3, i6);
                    bitMatrix.set((i4 / 2) + i3, i6);
                    bitMatrix.set(i6, (i4 / 2) - i3);
                    bitMatrix.set(i6, (i4 / 2) + i3);
                }
                i7 += 15;
                i3 += 16;
