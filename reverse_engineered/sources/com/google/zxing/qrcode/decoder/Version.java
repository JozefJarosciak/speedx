...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(2, AVException.OBJECT_TOO_LARGE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(3, AVException.PUSH_MISCONFIGURED), new ECB(1, AVException.OBJECT_TOO_LARGE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(5, 120), new ECB(1, AVException.INVALID_NESTED_KEY));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(4, AVException.OBJECT_TOO_LARGE), new ECB(4, 117));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(4, AVException.INVALID_NESTED_KEY), new ECB(5, AVException.INVALID_FILE_NAME));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(10, 114), new ECB(2, AVException.PUSH_MISCONFIGURED));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(8, AVException.INVALID_FILE_NAME), new ECB(4, AVException.INVALID_ACL));
        ...
        iArr = new int[]{6, 26, 50, 74, 98, AVException.INVALID_FILE_NAME};
        eCBlocksArr = new ECBlocks[4];
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(7, AVException.OBJECT_TOO_LARGE), new ECB(7, 117));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(5, AVException.PUSH_MISCONFIGURED), new ECB(10, AVException.OBJECT_TOO_LARGE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(13, AVException.PUSH_MISCONFIGURED), new ECB(3, AVException.OBJECT_TOO_LARGE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(17, AVException.PUSH_MISCONFIGURED));
        ...
        iArr = new int[]{6, 30, 58, 86, 114, AVException.VALIDATION_ERROR};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(17, AVException.PUSH_MISCONFIGURED), new ECB(1, AVException.OBJECT_TOO_LARGE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(13, AVException.PUSH_MISCONFIGURED), new ECB(6, AVException.OBJECT_TOO_LARGE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(12, AVException.INVALID_NESTED_KEY), new ECB(7, AVException.INVALID_FILE_NAME));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(6, AVException.INVALID_NESTED_KEY), new ECB(14, AVException.INVALID_FILE_NAME));
        ...
        iArr = new int[]{6, 28, 54, 80, 106, Opcodes.IINC, Opcodes.IFLE};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(17, AVException.INVALID_FILE_NAME), new ECB(4, AVException.INVALID_ACL));
        ...
        iArr = new int[]{6, 32, 58, 84, 110, SyslogConstants.LOG_LOCAL1, 162};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(4, AVException.INVALID_FILE_NAME), new ECB(18, AVException.INVALID_ACL));
        ...
        iArr = new int[]{6, 26, 54, 82, 110, 138, Opcodes.IF_ACMPNE};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 30, 58, 86, 114, AVException.VALIDATION_ERROR, 170};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(19, 118), new ECB(6, AVException.OPERATION_FORBIDDEN));
