    ...
    public static class PhoneNumberDesc implements Externalizable {
        ...
        public static final class Builder extends PhoneNumberDesc {
            ...
            public Builder mergeFrom(PhoneNumberDesc phoneNumberDesc) {
                ...
                while (i < phoneNumberDesc.getPossibleLengthLocalOnlyCount()) {
                    addPossibleLengthLocalOnly(phoneNumberDesc.getPossibleLengthLocalOnly(i));
                    i++;
                }
        ...
        public void writeExternal(ObjectOutput objectOutput) throws IOException {
            ...
            for (i = 0; i < possibleLengthCount; i++) {
