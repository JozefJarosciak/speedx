...
public interface zza extends IInterface {
    ...
    public static abstract class zza extends Binder implements zza {
        ...
        private static class zza implements zza {
            ...
            public zzd zzbqk() throws RemoteException {
            ...
            public zzd zzkw(String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
            ...
            public zzd zzkx(String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
            ...
            public zzd zzky(String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
            ...
            public zzd zzvd(int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
        ...
        public static zza zzir(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 6:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
                    zzvd = zzc(parcel.readInt() != 0 ? (Bitmap) Bitmap.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    if (zzvd != null) {
                        iBinder = zzvd.asBinder();
                    }
    ...
    zzd zzbqk() throws RemoteException;

    zzd zzc(Bitmap bitmap) throws RemoteException;

    zzd zzi(float f) throws RemoteException;

    zzd zzkw(String str) throws RemoteException;

    zzd zzkx(String str) throws RemoteException;

    zzd zzky(String str) throws RemoteException;

    zzd zzvd(int i) throws RemoteException;
}
