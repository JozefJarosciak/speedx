...
public class StreetViewPanoramaCamera implements SafeParcelable {
    ...
    StreetViewPanoramaCamera(int i, float f, float f2, float f3) {
        ...
        zzab.zzb(z, (Object) "Tilt needs to be between -90 and 90 inclusive");
        this.mVersionCode = i;
        if (((double) f) <= 0.0d) {
            f = 0.0f;
        }
        ...
        this.aiS = new com.google.android.gms.maps.model.StreetViewPanoramaOrientation.Builder().tilt(f2).bearing(f3).build();
    }
    ...
    public String toString() {
        return zzaa.zzz(this).zzg(MapboxEvent.KEY_ZOOM, Float.valueOf(this.zoom)).zzg("tilt", Float.valueOf(this.tilt)).zzg("bearing", Float.valueOf(this.bearing)).toString();
    }
