...
public interface ILocationSourceDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements ILocationSourceDelegate {
        ...
        private static class zza implements ILocationSourceDelegate {
            ...
            public void activate(zzl zzl) throws RemoteException {
        ...
        public static ILocationSourceDelegate zzhk(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    activate(com.google.android.gms.maps.internal.zzl.zza.zzhu(parcel.readStrongBinder()));
    ...
    void activate(zzl zzl) throws RemoteException;
