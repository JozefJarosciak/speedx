...
public interface IProjectionDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IProjectionDelegate {
        ...
        public static IProjectionDelegate zzil(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    LatLng fromScreenLocation = fromScreenLocation(com.google.android.gms.dynamic.zzd.zza.zzfc(parcel.readStrongBinder()));
