...
public class LocationAvailabilityCreator implements Creator<LocationAvailability> {
    ...
    static void zza(LocationAvailability locationAvailability, Parcel parcel, int i) {
        ...
        zzb.zzc(parcel, 1, locationAvailability.acZ);
        zzb.zzc(parcel, 2, locationAvailability.ada);
        zzb.zza(parcel, 3, locationAvailability.adb);
        zzb.zzc(parcel, 4, locationAvailability.adc);
