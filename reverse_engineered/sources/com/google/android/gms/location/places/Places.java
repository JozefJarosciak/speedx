...
public class Places {
    public static final Api<PlacesOptions> GEO_DATA_API = new Api("Places.GEO_DATA_API", new zza(), aeU);
    public static final GeoDataApi GeoDataApi = new zzd();
    public static final Api<PlacesOptions> PLACE_DETECTION_API = new Api("Places.PLACE_DETECTION_API", new zzk.zza(), aeV);
    public static final PlaceDetectionApi PlaceDetectionApi = new zzj();
    public static final zzf<zze> aeU = new zzf();
    public static final zzf<zzk> aeV = new zzf();
