...
public enum zzag {
    ...
    COUNTRY(GeocodingCriteria.TYPE_COUNTRY),
    CSS_ID("css_id"),
    ...
    HTML(DirectionsCriteria.INSTRUCTIONS_HTML),
    ID("id"),
    ...
    LOCALE("locale"),
    LOCATION(MapboxEvent.TYPE_LOCATION),
