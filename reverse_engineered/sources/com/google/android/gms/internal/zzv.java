...
public class zzv implements zzb {
    ...
    static class zza {
        ...
        public zza(String str, com.google.android.gms.internal.zzb.zza zza) {
            this.zzcb = str;
            this.zzca = (long) zza.data.length;
            this.zza = zza.zza;
            this.zzb = zza.zzb;
            this.zzc = zza.zzc;
            this.zzd = zza.zzd;
    ...
    private void zza(String str, zza zza) {
        if (this.zzbw.containsKey(str)) {
            ...
            this.zzbx = (zza.zzca - zza2.zzca) + this.zzbx;
        } else {
            this.zzbx += zza.zzca;
        }
        this.zzbw.put(str, zza);
    }
    ...
    private void zzc(int i) {
        if (this.zzbx + ((long) i) >= ((long) this.zzbz)) {
            ...
            while (it.hasNext()) {
                ...
                if (zzf(zza.zzcb).delete()) {
                    this.zzbx -= zza.zzca;
                } else {
                    zzs.zzb("Could not delete cache entry for key=%s, filename=%s", zza.zzcb, zze(zza.zzcb));
                }
                it.remove();
                i2 = i3 + 1;
    ...
    public synchronized com.google.android.gms.internal.zzb.zza zza(String str) {
        ...
        if (zza2 == null) {
            ...
            try {
                ...
                try {
                    zza.zzf(zzb);
                    zza = zza2.zzb(zza((InputStream) zzb, (int) (zzf.length() - ((long) zzb.zzcc))));
                    if (zzb != null) {
                        try {
                            zzb.close();
                        } catch (IOException e2) {
