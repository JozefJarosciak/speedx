...
public final class zzapd {
    ...
    private static void zza(byte[] bArr, StringBuffer stringBuffer) {
        ...
        for (byte b : bArr) {
            int i = b & 255;
            if (i == 92 || i == 34) {
                stringBuffer.append(CoreConstants.ESCAPE_CHAR).append((char) i);
            } else if (i < 32 || i >= 127) {
    ...
    private static String zzib(String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (charAt < ' ' || charAt > '~' || charAt == CoreConstants.DOUBLE_QUOTE_CHAR || charAt == CoreConstants.SINGLE_QUOTE_CHAR) {
