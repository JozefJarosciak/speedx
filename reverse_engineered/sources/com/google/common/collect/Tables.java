...
public final class Tables {
    private static final Function<? extends Map<?, ?>, ? extends Map<?, ?>> UNMODIFIABLE_WRAPPER = new C37271();
    ...
    static class C37271 implements Function<Map<Object, Object>, Map<Object, Object>> {
        C37271() {
        }
    ...
    private static class TransformedTable<R, C, V1, V2> extends AbstractTable<R, C, V2> {
        ...
        class C37281 implements Function<Cell<R, C, V1>, Cell<R, C, V2>> {
            C37281() {
            }
        ...
        class C37292 implements Function<Map<C, V1>, Map<C, V2>> {
            C37292() {
            }
        ...
        class C37303 implements Function<Map<R, V1>, Map<R, V2>> {
            C37303() {
            }
        ...
        public Map<R, Map<C, V2>> rowMap() {
            return Maps.transformValues(this.fromTable.rowMap(), new C37292());
        }

        public Map<C, Map<R, V2>> columnMap() {
            return Maps.transformValues(this.fromTable.columnMap(), new C37303());
        }
    }

    private static class TransposeTable<C, R, V> extends AbstractTable<C, R, V> {
        private static final Function<Cell<?, ?, ?>, Cell<?, ?, ?>> TRANSPOSE_CELL = new C37311();
        final Table<R, C, V> original;

        /* renamed from: com.google.common.collect.Tables$TransposeTable$1 */
        static class C37311 implements Function<Cell<?, ?, ?>, Cell<?, ?, ?>> {
            C37311() {
            }
