...
public class TreeBasedTable<R, C, V> extends StandardRowSortedTable<R, C, V> {
    ...
    class C37321 implements Function<Map<C, V>, Iterator<C>> {
        C37321() {
        }
    ...
    private class TreeRow extends StandardTable$Row implements SortedMap<C, V> {
        final C lowerBound;
        final C upperBound;
        ...
        SortedMap<C, V> computeBackingRowMap() {
            ...
            if (this.upperBound != null) {
                return wholeRow.headMap(this.upperBound);
            }
            return wholeRow;
        }
    ...
    Iterator<C> createColumnKeyIterator() {
        ...
        final Iterator mergeSorted = Iterators.mergeSorted(Iterables.transform(this.backingMap.values(), new C37321()), columnComparator);
