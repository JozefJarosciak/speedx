...
public final class Maps {
    ...
    static abstract class DescendingMap<K, V> extends ForwardingMap<K, V> implements NavigableMap<K, V> {
        ...
        class C36571 extends EntrySet<K, V> {
            C36571() {
            }
    ...
    private static class AsMapView<K, V> extends ImprovedAbstractMap<K, V> {
        ...
        class C36561 extends EntrySet<K, V> {
            C36561() {
            }
    ...
    static class TransformedEntriesMap<K, V1, V2> extends ImprovedAbstractMap<K, V2> {
        ...
        class C36641 extends EntrySet<K, V2> {
            C36641() {
            }
    ...
    public static <K, V> SortedMapDifference<K, V> difference(SortedMap<K, ? extends V> sortedMap, Map<? extends K, ? extends V> map) {
        ...
        Object newTreeMap = newTreeMap(orNaturalOrder);
        Object newTreeMap2 = newTreeMap(orNaturalOrder);
        newTreeMap2.putAll(map);
        Object newTreeMap3 = newTreeMap(orNaturalOrder);
        Object newTreeMap4 = newTreeMap(orNaturalOrder);
    ...
    static String toStringImpl(Map<?, ?> map) {
        StringBuilder append = Collections2.newStringBuilderForCollection(map.size()).append(CoreConstants.CURLY_LEFT);
