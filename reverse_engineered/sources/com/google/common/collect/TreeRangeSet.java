            ...
            return new AbstractIterator<Entry<Cut<C>, Range<C>>>() {
                ...
                protected Entry<Cut<C>, Range<C>> computeNext() {
                    ...
                    if (peekingIterator.hasNext()) {
                        ...
                        Range create = Range.create(this.nextComplementRangeLowerBound, range.lowerBound);
        ...
        Iterator<Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            if (peekingIterator.hasNext()) {
                if (((Range) peekingIterator.peek()).upperBound == Cut.aboveAll()) {
                    aboveAll = ((Range) peekingIterator.next()).lowerBound;
                } else {
            ...
            cut = (Cut) MoreObjects.firstNonNull(aboveAll, Cut.aboveAll());
            return new AbstractIterator<Entry<Cut<C>, Range<C>>>() {
