...
public abstract class AbstractExecutionThreadService implements Service {
    ...
    class C38391 extends AbstractService {
        ...
        class C38382 implements Runnable {
            C38382() {
            }
            ...
            public void run() {
                try {
                    ...
                    C38391.this.notifyStarted();
                    if (C38391.this.isRunning()) {
                        AbstractExecutionThreadService.this.run();
                    }
                    AbstractExecutionThreadService.this.shutDown();
                    C38391.this.notifyStopped();
                } catch (Throwable th) {
                    C38391.this.notifyFailed(th);
        ...
        protected final void doStart() {
            MoreExecutors.renamingDecorator(AbstractExecutionThreadService.this.executor(), new C38371()).execute(new C38382());
        }
    ...
    class C38402 implements Executor {
        C38402() {
        }
