...
public abstract class RateLimiter {
    ...
    static abstract class SleepingStopwatch {
        ...
        static class C38901 extends SleepingStopwatch {
    ...
    public static RateLimiter create(double d, long j, TimeUnit timeUnit) {
        ...
        Preconditions.checkArgument(z, "warmupPeriod must not be negative: %s", Long.valueOf(j));
    ...
    static RateLimiter create(SleepingStopwatch sleepingStopwatch, double d, long j, TimeUnit timeUnit) {
        RateLimiter smoothWarmingUp = new SmoothWarmingUp(sleepingStopwatch, j, timeUnit);
    ...
    public boolean tryAcquire(int i, long j, TimeUnit timeUnit) {
        ...
        synchronized (mutex()) {
            ...
            if (canAcquire(readMicros, max)) {
                max = reserveAndGetWaitLength(i, readMicros);
    ...
    private static int checkPermits(int i) {
        ...
        Preconditions.checkArgument(z, "Requested permits (%s) must be positive", Integer.valueOf(i));
        return i;
    }
}
