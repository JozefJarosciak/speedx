...
public class JsonReader implements Closeable {
    ...
    static class C40551 extends JsonReaderInternalAccess {
        C40551() {
        }
    ...
    static {
        JsonReaderInternalAccess.INSTANCE = new C40551();
    }
    ...
    public String nextName() throws IOException {
        ...
        if (i == 14) {
            ...
            nextUnquotedValue = nextQuotedValue(CoreConstants.SINGLE_QUOTE_CHAR);
        } else if (i == 13) {
            nextUnquotedValue = nextQuotedValue(CoreConstants.DOUBLE_QUOTE_CHAR);
        } else {
