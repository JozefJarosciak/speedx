...
/* renamed from: com.google.gson.jpush.internal.a.bb */
final class bb extends al<Number> {
    bb() {
    }

    /* renamed from: b */
    private static Number m16227b(C3976a c3976a) {
        if (c3976a.mo5683f() == C3979c.f14328i) {
            c3976a.mo5687j();
            return null;
        }
        try {
            return Byte.valueOf((byte) c3976a.mo5690m());
        } catch (Throwable e) {
            throw new af(e);
        }
    }
