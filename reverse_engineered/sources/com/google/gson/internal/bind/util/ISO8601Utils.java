...
public class ISO8601Utils {
    ...
    public static String format(Date date, boolean z, TimeZone timeZone) {
        ...
        if (length != 0) {
            int abs = Math.abs((length / CoreConstants.MILLIS_IN_ONE_MINUTE) / 60);
            int abs2 = Math.abs((length / CoreConstants.MILLIS_IN_ONE_MINUTE) % 60);
            stringBuilder.append(length < 0 ? CoreConstants.DASH_CHAR : '+');
    ...
    public static Date parse(String str, ParsePosition parsePosition) throws ParseException {
        ...
        try {
            ...
            if (checkOffset(str, i, CoreConstants.DASH_CHAR)) {
                index = i + 1;
            } else {
                index = i;
            }
            ...
            if (checkOffset || str.length() > i) {
                ...
                if (checkOffset) {
                    ...
                    if (checkOffset(str, i, CoreConstants.COLON_CHAR)) {
                        index = i + 1;
                    } else {
                        index = i;
                    }
                    ...
                    if (str.length() > i) {
                        ...
                        if (!(charAt == 'Z' || charAt == '+' || charAt == CoreConstants.DASH_CHAR)) {
                            i2 = i + 2;
                            i = parseInt(str, i, i2);
                            if (i > 59 && i < 63) {
                                i = 59;
                            }
                            if (checkOffset(str, i2, CoreConstants.DOT)) {
                                i3 = i2 + 1;
                ...
                if (charAt2 == 'Z') {
                    ...
                    i++;
                } else if (charAt2 == '+' || charAt2 == CoreConstants.DASH_CHAR) {
            ...
            if (str == null) {
                ...
                substring = CoreConstants.DOUBLE_QUOTE_CHAR + str + "'";
            }
