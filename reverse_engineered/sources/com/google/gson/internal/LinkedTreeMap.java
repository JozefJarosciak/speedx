...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C39441();
    ...
    static class C39441 implements Comparator<Comparable> {
        C39441() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C39451 extends LinkedTreeMapIterator<Entry<K, V>> {
            C39451() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C39461 extends LinkedTreeMapIterator<K> {
            C39461() {
                super();
            }
