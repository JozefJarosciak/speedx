...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C39411();
    ...
    static class C39411 implements Comparator<Comparable> {
        C39411() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C39421 extends LinkedTreeMapIterator<Entry<K, V>> {
            C39421() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C39431 extends LinkedTreeMapIterator<K> {
            C39431() {
                super();
            }
