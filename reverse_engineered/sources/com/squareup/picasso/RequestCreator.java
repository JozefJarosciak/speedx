...
public class RequestCreator {
    ...
    public RequestCreator priority(Picasso$Priority picasso$Priority) {
        this.data.priority(picasso$Priority);
        return this;
    }
    ...
    private Request createRequest(long j) {
        ...
        if (z) {
            Utils.log("Main", MapboxEvent.ATTRIBUTE_CREATED, build.plainId(), build.toString());
        }
