...
public final class C4418b {
    /* renamed from: a */
    private static String f15312a = null;
    /* renamed from: b */
    private static String f15313b = null;

    /* renamed from: a */
    public static String m17358a() {
        try {
            return Build.MODEL;
        } catch (Throwable th) {
    ...
    /* renamed from: a */
    public static String m17359a(Context context) {
        String deviceId;
        if (context == null) {
            return null;
        }
        if (AppInfo.m17296a(context, "android.permission.READ_PHONE_STATE")) {
            try {
                ...
                try {
                    ...
                    C4475w.m17747a("Failed to get IMEI.", new Object[0]);
                    return deviceId;
                }
            } catch (Throwable th2) {
                deviceId = null;
        ...
        C4475w.m17752d("no READ_PHONE_STATE permission to get IMEI", new Object[0]);
        return null;
    }

    /* renamed from: b */
    public static String m17362b(Context context) {
        String subscriberId;
        if (context == null) {
            return null;
        }
        if (AppInfo.m17296a(context, "android.permission.READ_PHONE_STATE")) {
            try {
                ...
                try {
                    ...
                    C4475w.m17747a("Failed to get IMSI.", new Object[0]);
                    return subscriberId;
                }
            } catch (Throwable th2) {
                subscriberId = null;
        ...
        C4475w.m17752d("no READ_PHONE_STATE permission to get IMSI", new Object[0]);
        return null;
    }

    /* renamed from: c */
    public static String m17364c(Context context) {
        Throwable th;
        String str = "fail";
        if (context == null) {
            return str;
        ...
        try {
            ...
            try {
                ...
                C4475w.m17747a("Failed to get Android ID.", new Object[0]);
                return str;
            }
        } catch (Throwable th4) {
            th = th4;
    ...
    /* renamed from: d */
    public static String m17366d(Context context) {
        String str = "fail";
        if (context == null) {
            return str;
        }
    ...
    /* renamed from: o */
    private static boolean m17384o() {
        try {
    ...
    /* renamed from: p */
    private static java.lang.String m17385p() {
        /*
        r6 = 2;
        r1 = 0;
    ...
    L_0x004f:
        r1 = move-exception;
        r2 = com.tencent.bugly.proguard.C4475w.m17748a(r1);
    ...
    L_0x0065:
        ...
        r3 = r1;
    L_0x0068:
        r4 = com.tencent.bugly.proguard.C4475w.m17748a(r0);	 Catch:{ all -> 0x00ba }
    ...
    L_0x007d:
        r0 = move-exception;
        r2 = com.tencent.bugly.proguard.C4475w.m17748a(r0);
        if (r2 != 0) goto L_0x0076;
    L_0x0084:
        r0.printStackTrace();
        goto L_0x0076;
    ...
    /* renamed from: a */
    public static String m17360a(boolean z) {
        String str = null;
        if (z) {
            try {
                str = C4418b.m17385p();
    ...
    /* renamed from: e */
    public static String m17368e(Context context) {
    ...
    /* renamed from: f */
    public static String m17370f(Context context) {
        String a = C4479y.m17780a(context, "ro.miui.ui.version.name");
        if (!C4479y.m17792a(a) && !a.equals("fail")) {
            return "XiaoMi/MIUI/" + a;
        }
        a = C4479y.m17780a(context, "ro.build.version.emui");
        if (!C4479y.m17792a(a) && !a.equals("fail")) {
            return "HuaWei/EMOTION/" + a;
        }
        a = C4479y.m17780a(context, "ro.lenovo.series");
        if (C4479y.m17792a(a) || a.equals("fail")) {
            a = C4479y.m17780a(context, "ro.build.nubia.rom.name");
            if (!C4479y.m17792a(a) && !a.equals("fail")) {
                return "Zte/NUBIA/" + a + "_" + C4479y.m17780a(context, "ro.build.nubia.rom.code");
            }
            a = C4479y.m17780a(context, "ro.meizu.product.model");
            if (!C4479y.m17792a(a) && !a.equals("fail")) {
                return "Meizu/FLYME/" + C4479y.m17780a(context, "ro.build.display.id");
            }
            a = C4479y.m17780a(context, "ro.build.version.opporom");
            if (!C4479y.m17792a(a) && !a.equals("fail")) {
                return "Oppo/COLOROS/" + a;
            }
            a = C4479y.m17780a(context, "ro.vivo.os.build.display.id");
            if (!C4479y.m17792a(a) && !a.equals("fail")) {
                return "vivo/FUNTOUCH/" + a;
            }
            a = C4479y.m17780a(context, "ro.aa.romver");
            if (!C4479y.m17792a(a) && !a.equals("fail")) {
                return "htc/" + a + "/" + C4479y.m17780a(context, "ro.build.description");
            }
            a = C4479y.m17780a(context, "ro.lewa.version");
            if (!C4479y.m17792a(a) && !a.equals("fail")) {
                return "tcl/" + a + "/" + C4479y.m17780a(context, "ro.build.display.id");
            }
            a = C4479y.m17780a(context, "ro.gn.gnromvernumber");
            if (!C4479y.m17792a(a) && !a.equals("fail")) {
                return "amigo/" + a + "/" + C4479y.m17780a(context, "ro.build.display.id");
            }
            a = C4479y.m17780a(context, "ro.build.tyd.kbstyle_version");
            if (C4479y.m17792a(a) || a.equals("fail")) {
                return C4479y.m17780a(context, "ro.build.fingerprint") + "/" + C4479y.m17780a(context, "ro.build.rom.id");
            }
            return "dido/" + a;
        }
        return "Lenovo/VIBE/" + C4479y.m17780a(context, "ro.build.version.incremental");
    }

    /* renamed from: g */
    public static String m17372g(Context context) {
        return C4479y.m17780a(context, "ro.board.platform");
    }

    /* renamed from: h */
    public static boolean m17374h(Context context) {
        boolean z;
        boolean exists;
        try {
        ...
        Boolean bool = null;
        ArrayList a = C4479y.m17785a(context, new String[]{"/system/bin/sh", "-c", "type su"});
        if (a != null && a.size() > 0) {
            Iterator it = a.iterator();
            while (it.hasNext()) {
                Boolean valueOf;
                String str = (String) it.next();
                C4475w.m17751c(str, new Object[0]);
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    /* renamed from: l */
    public static java.lang.String m17381l() {
        /*
        r0 = 0;
    ...
    L_0x0088:
        r1 = move-exception;
        com.tencent.bugly.proguard.C4475w.m17748a(r1);
        goto L_0x0087;
    L_0x008d:
        r1 = move-exception;
        r1 = r0;
    ...
    /* renamed from: i */
    public static String m17376i(Context context) {
        StringBuilder stringBuilder = new StringBuilder();
        String a = C4479y.m17780a(context, "ro.genymotion.version");
        if (a != null) {
        ...
        a = C4479y.m17780a(context, "androVM.vbox_dpi");
        if (a != null) {
        ...
        a = C4479y.m17780a(context, "qemu.sf.fake_camera");
        if (a != null) {
    ...
    /* renamed from: j */
    public static String m17378j(Context context) {
        Throwable th;
        StringBuilder stringBuilder = new StringBuilder();
        if (f15312a == null) {
            f15312a = C4479y.m17780a(context, "ro.secure");
        }
        if (f15312a != null) {
            stringBuilder.append("ro.secure");
            stringBuilder.append("|");
            stringBuilder.append(f15312a);
            stringBuilder.append("\n");
        }
        if (f15313b == null) {
            f15313b = C4479y.m17780a(context, "ro.debuggable");
        }
        if (f15313b != null) {
            stringBuilder.append("ro.debuggable");
            stringBuilder.append("|");
            stringBuilder.append(f15313b);
            stringBuilder.append("\n");
        }
        BufferedReader bufferedReader;
        try {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    /* renamed from: m */
    public static java.lang.String m17382m() {
        /*
    ...
    /* renamed from: k */
    public static String m17380k(Context context) {
        StringBuilder stringBuilder = new StringBuilder();
        String a = C4479y.m17780a(context, "gsm.sim.state");
        if (a != null) {
        ...
        stringBuilder.append("\n");
        a = C4479y.m17780a(context, "gsm.sim.state2");
        if (a != null) {
