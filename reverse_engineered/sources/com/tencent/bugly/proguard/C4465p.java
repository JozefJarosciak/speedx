...
public final class C4465p extends SQLiteOpenHelper {
    /* renamed from: a */
    private static int f15712a = 13;
    /* renamed from: b */
    private Context f15713b;
    /* renamed from: c */
    private List<C4401a> f15714c;

    public C4465p(Context context, List<C4401a> list) {
        StringBuilder stringBuilder = new StringBuilder("bugly_db_");
        C4417a.m17303a(context).getClass();
        super(context, stringBuilder.toString(), null, f15712a);
    ...
    public final synchronized void onCreate(SQLiteDatabase sQLiteDatabase) {
        try {
            ...
            C4475w.m17751c(stringBuilder.toString(), new Object[0]);
        ...
        if (this.f15714c != null) {
            for (C4401a onDbCreate : this.f15714c) {
                try {
                    onDbCreate.onDbCreate(sQLiteDatabase);
                } catch (Throwable th2) {
                    if (!C4475w.m17750b(th2)) {
                        th2.printStackTrace();
                    }
                }
            }
    ...
    /* renamed from: a */
    private synchronized boolean m17696a(SQLiteDatabase sQLiteDatabase) {
        boolean z = true;
        synchronized (this) {
            try {
    ...
    public final synchronized void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        C4475w.m17752d("[Database] Upgrade %d to %d , drop tables!", Integer.valueOf(i), Integer.valueOf(i2));
        if (this.f15714c != null) {
            for (C4401a onDbUpgrade : this.f15714c) {
                try {
        ...
        if (m17696a(sQLiteDatabase)) {
            onCreate(sQLiteDatabase);
        } else {
            C4475w.m17752d("[Database] Failed to drop, delete db.", new Object[0]);
            File databasePath = this.f15713b.getDatabasePath("bugly_db");
    ...
    public final synchronized void onDowngrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        if (C4418b.m17363c() >= 11) {
            C4475w.m17752d("[Database] Downgrade %d to %d drop tables.", Integer.valueOf(i), Integer.valueOf(i2));
            if (this.f15714c != null) {
                for (C4401a onDbDowngrade : this.f15714c) {
                    try {
        ...
        synchronized (this) {
            ...
            while (sQLiteDatabase == null && i < 5) {
                ...
                try {
                    ...
                    C4475w.m17752d("[Database] Try to get db(count: %d).", Integer.valueOf(i));
                    if (i == 5) {
                        C4475w.m17753e("[Database] Failed to get db.", new Object[0]);
                    }
                    try {
                        Thread.sleep(200);
    ...
    public final synchronized SQLiteDatabase getWritableDatabase() {
        ...
        synchronized (this) {
            ...
            if (sQLiteDatabase == null) {
                C4475w.m17752d("[Database] db error delay error record 1min.", new Object[0]);
            }
        }
        return sQLiteDatabase;
    }
