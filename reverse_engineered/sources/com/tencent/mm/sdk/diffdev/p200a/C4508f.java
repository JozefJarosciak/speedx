...
final class C4508f extends AsyncTask<Void, Void, C4507a> {
    ...
    static class C4507a {
        ...
        /* renamed from: e */
        public static com.tencent.mm.sdk.diffdev.p200a.C4508f.C4507a m17854e(byte[] r9) {
            /*
            r8 = 1;
            r7 = 0;
    ...
    public C4508f(String str, OAuthListener oAuthListener) {
        this.aq = str;
    ...
    protected final /* synthetic */ Object doInBackground(Object[] objArr) {
        if (this.aq == null || this.aq.length() == 0) {
            ...
            c4507a.ap = OAuthErrCode.WechatAuth_Err_NormalErr;
            return c4507a;
        }
        while (!isCancelled()) {
            String str = this.url + (this.aw == 0 ? "" : "&last=" + this.aw);
            long currentTimeMillis = System.currentTimeMillis();
            byte[] b = C4506e.m17853b(str, CoreConstants.MILLIS_IN_ONE_MINUTE);
            long currentTimeMillis2 = System.currentTimeMillis();
            c4507a = C4507a.m17854e(b);
            Log.d("MicroMsg.SDK.NoopingTask", String.format("nooping, url = %s, errCode = %s, uuidStatusCode = %d, time consumed = %d(ms)", new Object[]{str, c4507a.ap.toString(), Integer.valueOf(c4507a.ay), Long.valueOf(currentTimeMillis2 - currentTimeMillis)}));
            if (c4507a.ap == OAuthErrCode.WechatAuth_Err_OK) {
                this.aw = c4507a.ay;
                if (c4507a.ay == C4509g.UUID_SCANED.getCode()) {
                    this.an.onQrcodeScanned();
                } else if (c4507a.ay != C4509g.UUID_KEEP_CONNECT.getCode() && c4507a.ay == C4509g.UUID_CONFIRM.getCode()) {
                    if (c4507a.ax != null && c4507a.ax.length() != 0) {
                        return c4507a;
                    }
            ...
            Log.e("MicroMsg.SDK.NoopingTask", String.format("nooping fail, errCode = %s, uuidStatusCode = %d", new Object[]{c4507a.ap.toString(), Integer.valueOf(c4507a.ay)}));
            return c4507a;
        }
        Log.i("MicroMsg.SDK.NoopingTask", "IDiffDevOAuth.stopAuth / detach invoked");
        c4507a = new C4507a();
        c4507a.ap = OAuthErrCode.WechatAuth_Err_Auth_Stopped;
        return c4507a;
    }

    protected final /* synthetic */ void onPostExecute(Object obj) {
        C4507a c4507a = (C4507a) obj;
        this.an.onAuthFinish(c4507a.ap, c4507a.ax);
    }
}
