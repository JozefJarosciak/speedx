...
public final class C4496g implements Runnable {
    ...
    public interface C4493a {
        /* renamed from: c */
        void mo6085c(Runnable runnable, C4496g c4496g);
    }
    ...
    C4496g(Thread thread, Handler handler, Runnable runnable, Object obj, C4493a c4493a) {
        this.aT = thread;
        if (thread != null) {
        ...
        if (!C4497h.m17842h(obj2)) {
            int indexOf = obj2.indexOf(AVException.TIMEOUT);
            if (indexOf > 0) {
