...
public class PayReq extends BaseReq {
    ...
    public static class Options {
        ...
        public void fromBundle(Bundle bundle) {
            this.callbackClassName = C4487a.m17821b(bundle, "_wxapi_payoptions_callback_classname");
            this.callbackFlags = C4487a.m17820a(bundle, "_wxapi_payoptions_callback_flags");
        }
    ...
    public boolean checkArgs() {
        if (this.appId == null || this.appId.length() == 0) {
            C4489b.m17827b(TAG, "checkArgs fail, invalid appId");
            return false;
        } else if (this.partnerId == null || this.partnerId.length() == 0) {
            C4489b.m17827b(TAG, "checkArgs fail, invalid partnerId");
            return false;
        } else if (this.prepayId == null || this.prepayId.length() == 0) {
            C4489b.m17827b(TAG, "checkArgs fail, invalid prepayId");
            return false;
        } else if (this.nonceStr == null || this.nonceStr.length() == 0) {
            C4489b.m17827b(TAG, "checkArgs fail, invalid nonceStr");
            return false;
        } else if (this.timeStamp == null || this.timeStamp.length() == 0) {
            C4489b.m17827b(TAG, "checkArgs fail, invalid timeStamp");
            return false;
        } else if (this.packageValue == null || this.packageValue.length() == 0) {
            C4489b.m17827b(TAG, "checkArgs fail, invalid packageValue");
            return false;
        } else if (this.sign == null || this.sign.length() == 0) {
            C4489b.m17827b(TAG, "checkArgs fail, invalid sign");
            return false;
        } else if (this.extData == null || this.extData.length() <= 1024) {
            return true;
        } else {
            C4489b.m17827b(TAG, "checkArgs fail, extData length too long");
            return false;
        }
    }
    ...
    public void fromBundle(Bundle bundle) {
        ...
        this.appId = C4487a.m17821b(bundle, "_wxapi_payreq_appid");
        this.partnerId = C4487a.m17821b(bundle, "_wxapi_payreq_partnerid");
        this.prepayId = C4487a.m17821b(bundle, "_wxapi_payreq_prepayid");
        this.nonceStr = C4487a.m17821b(bundle, "_wxapi_payreq_noncestr");
        this.timeStamp = C4487a.m17821b(bundle, "_wxapi_payreq_timestamp");
        this.packageValue = C4487a.m17821b(bundle, "_wxapi_payreq_packagevalue");
        this.sign = C4487a.m17821b(bundle, "_wxapi_payreq_sign");
        this.extData = C4487a.m17821b(bundle, "_wxapi_payreq_extdata");
        this.signType = C4487a.m17821b(bundle, "_wxapi_payreq_sign_type");
