...
final class ServiceMethod<T> {
    ...
    private final Converter<C5569z, T> responseConverter;
    ...
    static final class Builder<T> {
        ...
        Converter<C5569z, T> responseConverter;
        Type responseType;
        ...
        public ServiceMethod build() {
            ...
            if (this.responseType == Response.class || this.responseType == C5627y.class) {
        ...
        private C5607q parseHeaders(String[] strArr) {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            if (annotation instanceof Url) {
                ...
                if (this.isMultipart) {
                    ...
                    if (!value.isEmpty()) {
                        C5607q a = C5607q.m20410a("Content-Disposition", "form-data; name=\"" + value + "\"", MIME.CONTENT_TRANSFER_ENC, part.encoding());
                        if (Iterable.class.isAssignableFrom(r1)) {
                            if (type instanceof ParameterizedType) {
                                r0 = Utils.getParameterUpperBound(0, (ParameterizedType) type);
                                if (!C5610b.class.isAssignableFrom(Utils.getRawType(r0))) {
                                    return new Part(a, this.retrofit.requestBodyConverter(r0, annotationArr, this.methodAnnotations)).iterable();
                                }
                            ...
                            if (!C5610b.class.isAssignableFrom(r0)) {
                                return new Part(a, this.retrofit.requestBodyConverter(r0, annotationArr, this.methodAnnotations)).array();
                            }
                            throw parameterError(i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                        } else if (!C5610b.class.isAssignableFrom(r1)) {
                            return new Part(a, this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations));
                        } else {
                            throw parameterError(i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                        }
                        ...
                        if (!(type instanceof ParameterizedType)) {
                            throw parameterError(i, r1.getSimpleName() + " must include generic type (e.g., " + r1.getSimpleName() + "<String>)", new Object[0]);
                        } else if (C5610b.class.isAssignableFrom(Utils.getRawType(Utils.getParameterUpperBound(0, (ParameterizedType) type)))) {
                        ...
                        if (C5610b.class.isAssignableFrom(r1.getComponentType())) {
                ...
                if (this.isMultipart) {
                    ...
                    if (Map.class.isAssignableFrom(r0)) {
                        ...
                        if (r0 instanceof ParameterizedType) {
                            ...
                            r0 = Utils.getParameterUpperBound(1, r0);
                            if (!C5610b.class.isAssignableFrom(Utils.getRawType(r0))) {
                                return new PartMap(this.retrofit.requestBodyConverter(r0, annotationArr, this.methodAnnotations), ((PartMap) annotation).encoding());
                            }
        ...
        private Converter<C5569z, T> createResponseConverter() {
            try {
    ...
    C5621w toRequest(Object... objArr) throws IOException {
        int length;
        int i = 0;
    ...
    T toResponse(C5569z c5569z) throws IOException {
        return this.responseConverter.convert(c5569z);
    }
